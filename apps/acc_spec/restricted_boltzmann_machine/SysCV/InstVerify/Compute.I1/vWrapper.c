...
struct l_unnamed16 { unsigned char array[9]; };
...
static struct l_unnamed7 _OC_str11 = { "wr_request_match" };
static struct l_unnamed10 _OC_str12 = { "wr_index_match" };
static struct l_unnamed0 _OC_str13 = { "wr_length_match" };
static struct l_unnamed10 _OC_str14 = { "data_out_match" };
static struct l_unnamed8 _OC_str15 = { "rd_complete_match" };
static struct l_unnamed2 _OC_str16 = { "index_match" };
static struct l_unnamed7 _OC_str17 = { "loop_count_match" };
static struct l_unnamed11 _OC_str18 = { "upc_match" };
static struct l_unnamed12 _OC_str19 = { "train_input_done_match" };
static struct l_unnamed13 _OC_str20 = { "predict_input_done_match" };
static struct l_unnamed1 _OC_str21 = { "data_match" };
static struct l_unnamed14 _OC_str22 = { "predict_result_match" };
static struct l_unnamed7 _OC_str23 = { "rd_request_match" };
struct l_struct_OC_rbm IMPL;
static struct l_unnamed15 _OC_str25 = { "clk" };
static struct l_unnamed15 _OC_str26 = { "rst" };
static struct l_unnamed16 _OC_str27 = { "rd_index" };
static struct l_unnamed11 _OC_str28 = { "rd_length" };
static struct l_unnamed1 _OC_str29 = { "rd_request" };
static struct l_unnamed16 _OC_str30 = { "rd_grant" };
static struct l_unnamed17 _OC_str31 = { "data_in" };
static struct l_unnamed16 _OC_str32 = { "wr_index" };
static struct l_unnamed11 _OC_str33 = { "wr_length" };
static struct l_unnamed1 _OC_str34 = { "wr_request" };
static struct l_unnamed16 _OC_str35 = { "wr_grant" };
static struct l_unnamed16 _OC_str36 = { "data_out" };
static struct l_unnamed18 _OC_str37 = { "done" };
static struct l_unnamed11 _OC_str38 = { "cond_done" };
static struct l_unnamed0 _OC_str39 = { "conf_num_hidden" };
static struct l_unnamed7 _OC_str40 = { "conf_num_visible" };
static struct l_unnamed10 _OC_str41 = { "conf_num_users" };
static struct l_unnamed10 _OC_str42 = { "conf_num_loops" };
...
void _ZN3rbm4loadEv(struct l_struct_OC_rbm *llvm_cbe_this) {
  ...
  unsigned short llvm_cbe_tmp__544;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__545;    /* Address-exposed local */
  ...
  unsigned int llvm_cbe_tmp__551;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__552;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__553;    /* Address-exposed local */
  ...
  unsigned int llvm_cbe_tmp__557;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__558;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__559;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__560;    /* Address-exposed local */
  ...
  unsigned short llvm_cbe_tmp__662;
  unsigned long long llvm_cbe_tmp__663;
  unsigned short llvm_cbe_tmp__664;
  ...
  unsigned char *llvm_cbe_tmp__752;
...
llvm_cbe_tmp__755:
  ...
  *(&llvm_cbe_tmp__544) = (((unsigned short )llvm_cbe_tmp__577));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field30)), (&llvm_cbe_tmp__544));
  llvm_cbe_tmp__578 = *((&GM.field12));
  *(&llvm_cbe_tmp__545) = (((unsigned short )llvm_cbe_tmp__578));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field31)), (&llvm_cbe_tmp__545));
  llvm_cbe_tmp__579 = *((&GM.field11));
  *(&llvm_cbe_tmp__546) = (((unsigned short )llvm_cbe_tmp__579));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field32)), (&llvm_cbe_tmp__546));
  llvm_cbe_tmp__580 = *((&GM.field8));
  *(&llvm_cbe_tmp__547) = (((unsigned short )llvm_cbe_tmp__580));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field33)), (&llvm_cbe_tmp__547));
  llvm_cbe_tmp__581 = *((&GM.field10));
  *(&llvm_cbe_tmp__548) = (((unsigned short )llvm_cbe_tmp__581));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field34)), (&llvm_cbe_tmp__548));
  llvm_cbe_tmp__582 = *((&GM.field9));
  *(&llvm_cbe_tmp__549) = (((unsigned short )llvm_cbe_tmp__582));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__574->field35)), (&llvm_cbe_tmp__549));
  ...
  *(&llvm_cbe_tmp__553) = ((unsigned char )1);
  llvm_cbe_tmp__588 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__574->field36)), (&llvm_cbe_tmp__553)))&1);
  *(&llvm_cbe_tmp__554) = ((unsigned char )0);
  llvm_cbe_tmp__589 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__574->field12)), (&llvm_cbe_tmp__554)))&1);
  ...
  *(&llvm_cbe_tmp__555) = (((unsigned char )(bool )(llvm_cbe_tmp__598 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field36)), (&llvm_cbe_tmp__555));
  llvm_cbe_tmp__599 = *((&GM.field2));
  *(&llvm_cbe_tmp__556) = (((unsigned char )(bool )(llvm_cbe_tmp__599 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field12)), (&llvm_cbe_tmp__556));
  llvm_cbe_tmp__600 = *((&GM.field16));
  *(&llvm_cbe_tmp__557) = (((unsigned int )llvm_cbe_tmp__600));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__574->field2)), (&llvm_cbe_tmp__557));
  llvm_cbe_tmp__601 = *((&GM.field17));
  *(&llvm_cbe_tmp__558) = (((unsigned int )llvm_cbe_tmp__601));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__574->field3)), (&llvm_cbe_tmp__558));
  llvm_cbe_tmp__602 = *((&GM.field18));
  *(&llvm_cbe_tmp__559) = (((unsigned char )(bool )(llvm_cbe_tmp__602 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field4)), (&llvm_cbe_tmp__559));
  ...
  *(&llvm_cbe_tmp__560) = (((unsigned char )(bool )(llvm_cbe_tmp__606 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field9)), (&llvm_cbe_tmp__560));
  llvm_cbe_tmp__607 = *((&GM.field22));
  *(&llvm_cbe_tmp__561) = (((unsigned int )llvm_cbe_tmp__607));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__574->field7)), (&llvm_cbe_tmp__561));
  llvm_cbe_tmp__608 = *((&GM.field23));
  *(&llvm_cbe_tmp__562) = (((unsigned int )llvm_cbe_tmp__608));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__574->field8)), (&llvm_cbe_tmp__562));
  llvm_cbe_tmp__609 = *((&GM.field1));
  *(&llvm_cbe_tmp__563) = (((unsigned int )llvm_cbe_tmp__609));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__574->field11)), (&llvm_cbe_tmp__563));
  ...
  *(&llvm_cbe_tmp__564) = (((unsigned char )(bool )(llvm_cbe_tmp__612 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field37)), (&llvm_cbe_tmp__564));
  llvm_cbe_tmp__613 = *((&GM.field13));
  *(&llvm_cbe_tmp__565) = (((unsigned char )(bool )(llvm_cbe_tmp__613 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field38)), (&llvm_cbe_tmp__565));
  ...
  *(&rd_complete) = 0u;
  llvm_cbe_tmp__620 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field5))))&1);
  if ((((llvm_cbe_tmp__620 ^ 1)&1))) {
...
llvm_cbe_tmp__756:
  _Z4waitv();
  *(&upc) = 1u;
  llvm_cbe_tmp__621 = *(&conf_done_inp);
  llvm_cbe_tmp__622 = *(&conf_num_hidden_inp);
  llvm_cbe_tmp__623 = *(&conf_num_visible_inp);
  llvm_cbe_tmp__624 = *(&conf_num_users_inp);
  llvm_cbe_tmp__625 = *(&conf_num_loops_inp);
  llvm_cbe_tmp__626 = *(&conf_num_testusers_inp);
  llvm_cbe_tmp__627 = *(&conf_num_movies_inp);
  llvm_cbe_tmp__628 = *(&rst_inp);
  llvm_cbe_tmp__629 = *(&rd_grant_inp);
  llvm_cbe_tmp__630 = *(&data_in_inp);
  llvm_cbe_tmp__631 = *(&wr_grant_inp);
  _ZN13model_compute6updateElllllllllll((&GM), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__621&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__622)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__623)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__624)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__625)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__626)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__627)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__628&1u))&1)))), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__629&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__630)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__631&1u))&1)))));
  llvm_cbe_tmp__632 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field36))))&1);
  llvm_cbe_tmp__633 = *((&GM.field5));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__632)) == llvm_cbe_tmp__633), ((&_OC_str1.array[((signed int )0u)])));
  llvm_cbe_tmp__634 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field12))))&1);
  llvm_cbe_tmp__635 = *((&GM.field2));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__634)) == llvm_cbe_tmp__635), ((&_OC_str2.array[((signed int )0u)])));
  llvm_cbe_tmp__636 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field30)));
  llvm_cbe_tmp__637 = *((&GM.field7));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__636)) == llvm_cbe_tmp__637), ((&_OC_str3.array[((signed int )0u)])));
  llvm_cbe_tmp__638 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field31)));
  llvm_cbe_tmp__639 = *((&GM.field12));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__638)) == llvm_cbe_tmp__639), ((&_OC_str4.array[((signed int )0u)])));
  llvm_cbe_tmp__640 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field32)));
  llvm_cbe_tmp__641 = *((&GM.field11));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__640)) == llvm_cbe_tmp__641), ((&_OC_str5.array[((signed int )0u)])));
  llvm_cbe_tmp__642 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field33)));
  llvm_cbe_tmp__643 = *((&GM.field8));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__642)) == llvm_cbe_tmp__643), ((&_OC_str6.array[((signed int )0u)])));
  llvm_cbe_tmp__644 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field34)));
  llvm_cbe_tmp__645 = *((&GM.field10));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__644)) == llvm_cbe_tmp__645), ((&_OC_str7.array[((signed int )0u)])));
  llvm_cbe_tmp__646 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field35)));
  llvm_cbe_tmp__647 = *((&GM.field9));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__646)) == llvm_cbe_tmp__647), ((&_OC_str8.array[((signed int )0u)])));
  llvm_cbe_tmp__648 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field2)));
  llvm_cbe_tmp__649 = *((&GM.field16));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__648)) == llvm_cbe_tmp__649), ((&_OC_str9.array[((signed int )0u)])));
  llvm_cbe_tmp__650 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field3)));
  llvm_cbe_tmp__651 = *((&GM.field17));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__650)) == llvm_cbe_tmp__651), ((&_OC_str10.array[((signed int )0u)])));
  llvm_cbe_tmp__652 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field9))))&1);
  llvm_cbe_tmp__653 = *((&GM.field24));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__652)) == llvm_cbe_tmp__653), ((&_OC_str11.array[((signed int )0u)])));
  llvm_cbe_tmp__654 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field7)));
  llvm_cbe_tmp__655 = *((&GM.field22));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__654)) == llvm_cbe_tmp__655), ((&_OC_str12.array[((signed int )0u)])));
  llvm_cbe_tmp__656 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field8)));
  llvm_cbe_tmp__657 = *((&GM.field23));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__656)) == llvm_cbe_tmp__657), ((&_OC_str13.array[((signed int )0u)])));
  llvm_cbe_tmp__658 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field11)));
  llvm_cbe_tmp__659 = *((&GM.field1));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__658)) == llvm_cbe_tmp__659), ((&_OC_str14.array[((signed int )0u)])));
  llvm_cbe_tmp__660 = *(&rd_complete);
  llvm_cbe_tmp__661 = *((&GM.field15));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__660)) == llvm_cbe_tmp__661), ((&_OC_str15.array[((signed int )0u)])));
  llvm_cbe_tmp__662 = *(&llvm_cbe_index);
  llvm_cbe_tmp__663 = *((&GM.field4));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__662)) == llvm_cbe_tmp__663), ((&_OC_str16.array[((signed int )0u)])));
  llvm_cbe_tmp__664 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__665 = *((&GM.field6));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__664)) == llvm_cbe_tmp__665), ((&_OC_str17.array[((signed int )0u)])));
  llvm_cbe_tmp__666 = *(&upc);
  llvm_cbe_tmp__667 = *((&GM.field20));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__666)) == llvm_cbe_tmp__667), ((&_OC_str18.array[((signed int )0u)])));
  llvm_cbe_tmp__668 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field37))))&1);
  llvm_cbe_tmp__669 = *((&GM.field19));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__668)) == llvm_cbe_tmp__669), ((&_OC_str19.array[((signed int )0u)])));
  llvm_cbe_tmp__670 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field38))))&1);
  llvm_cbe_tmp__671 = *((&GM.field13));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__670)) == llvm_cbe_tmp__671), ((&_OC_str20.array[((signed int )0u)])));
  llvm_cbe_tmp__672 = *((&GM.field0.field0));
  llvm_cbe_tmp__673 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__574->field20)), 0u);
  llvm_cbe_tmp__674 = ((__CPROVER_array_equal(llvm_cbe_tmp__672, llvm_cbe_tmp__673))&1);
  __CPROVER_assert(llvm_cbe_tmp__674, ((&_OC_str21.array[((signed int )0u)])));
  llvm_cbe_tmp__675 = *((&GM.field14.field0));
  llvm_cbe_tmp__676 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__574->field28)), 0u);
  llvm_cbe_tmp__677 = ((__CPROVER_array_equal(llvm_cbe_tmp__675, llvm_cbe_tmp__676))&1);
  __CPROVER_assert(llvm_cbe_tmp__677, ((&_OC_str22.array[((signed int )0u)])));
  goto llvm_cbe_tmp__758;

llvm_cbe_tmp__757:
  *(&llvm_cbe_tmp__566) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__574->field4)), (&llvm_cbe_tmp__566));
  llvm_cbe_tmp__678 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__679 = *(&llvm_cbe_nu);
  *(&llvm_cbe_tmp1) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__678))) * ((unsigned int )llvm_cbe_tmp__679))))));
  llvm_cbe_tmp__680 = *(&llvm_cbe_tmp1);
  llvm_cbe_tmp__681 = *(&llvm_cbe_index);
  *(&llvm_cbe_tmp2) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__680))) + ((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__681))))))));
  llvm_cbe_tmp__682 = *(&llvm_cbe_tmp2);
  *(&llvm_cbe_pingpong) = (((unsigned char )(bool )((((signed int )(((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__682))) % ((signed int )2u)))) != 0u)));
  *(&llvm_cbe_i) = ((unsigned short )0);
  goto llvm_cbe_tmp__759;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__759:
  llvm_cbe_tmp__683 = *(&llvm_cbe_i);
  if ((((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__683))) < ((signed int )500u))) {
...
llvm_cbe_tmp__762:
  llvm_cbe_tmp__686 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field6)));
  *(&llvm_cbe_rate) = (((unsigned char )llvm_cbe_tmp__686));
  _Z4waitv();
  llvm_cbe_tmp__687 = *(&llvm_cbe_rate);
  llvm_cbe_tmp__688 = *(&llvm_cbe_i);
  llvm_cbe_tmp__689 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__690 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__574->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__689&1u))&1)))));
  *((&llvm_cbe_tmp__690[((signed long long )(((unsigned long long )(unsigned short )llvm_cbe_tmp__688)))])) = llvm_cbe_tmp__687;
  *(&rd_complete) = 0u;
  llvm_cbe_tmp__691 = *(&llvm_cbe_i);
  *(&llvm_cbe_i) = (((unsigned short )(((unsigned short )(((unsigned short )llvm_cbe_tmp__691) + ((unsigned short )((unsigned short )1)))))));
  goto llvm_cbe_tmp__759;

llvm_cbe_tmp__760:
  llvm_cbe_tmp__684 = *(&llvm_cbe_i);
  llvm_cbe_tmp__685 = *(&llvm_cbe_nv);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__684)) == llvm_cbe_tmp__685)) {
    goto llvm_cbe_tmp__761;
  } else {
...
llvm_cbe_tmp__761:
  _Z4waitv();
  llvm_cbe_tmp__692 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__693 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__694 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__574->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__693&1u))&1)))));
  *((&llvm_cbe_tmp__694[((signed long long )(((unsigned long long )(unsigned int )llvm_cbe_tmp__692)))])) = ((unsigned char )1);
  *(&rd_complete) = 1u;
  llvm_cbe_tmp__695 = *(&conf_done_inp);
  llvm_cbe_tmp__696 = *(&conf_num_hidden_inp);
  llvm_cbe_tmp__697 = *(&conf_num_visible_inp);
  llvm_cbe_tmp__698 = *(&conf_num_users_inp);
  llvm_cbe_tmp__699 = *(&conf_num_loops_inp);
  llvm_cbe_tmp__700 = *(&conf_num_testusers_inp);
  llvm_cbe_tmp__701 = *(&conf_num_movies_inp);
  llvm_cbe_tmp__702 = *(&rst_inp);
  llvm_cbe_tmp__703 = *(&rd_grant_inp);
  llvm_cbe_tmp__704 = *(&data_in_inp);
  llvm_cbe_tmp__705 = *(&wr_grant_inp);
  _ZN13model_compute6updateElllllllllll((&GM), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__695&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__696)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__697)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__698)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__699)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__700)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__701)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__702&1u))&1)))), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__703&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__704)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__705&1u))&1)))));
  llvm_cbe_tmp__706 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field36))))&1);
  llvm_cbe_tmp__707 = *((&GM.field5));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__706)) == llvm_cbe_tmp__707), ((&_OC_str1.array[((signed int )0u)])));
  llvm_cbe_tmp__708 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field12))))&1);
  llvm_cbe_tmp__709 = *((&GM.field2));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__708)) == llvm_cbe_tmp__709), ((&_OC_str2.array[((signed int )0u)])));
  llvm_cbe_tmp__710 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field30)));
  llvm_cbe_tmp__711 = *((&GM.field7));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__710)) == llvm_cbe_tmp__711), ((&_OC_str3.array[((signed int )0u)])));
  llvm_cbe_tmp__712 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field31)));
  llvm_cbe_tmp__713 = *((&GM.field12));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__712)) == llvm_cbe_tmp__713), ((&_OC_str4.array[((signed int )0u)])));
  llvm_cbe_tmp__714 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field32)));
  llvm_cbe_tmp__715 = *((&GM.field11));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__714)) == llvm_cbe_tmp__715), ((&_OC_str5.array[((signed int )0u)])));
  llvm_cbe_tmp__716 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field33)));
  llvm_cbe_tmp__717 = *((&GM.field8));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__716)) == llvm_cbe_tmp__717), ((&_OC_str6.array[((signed int )0u)])));
  llvm_cbe_tmp__718 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field34)));
  llvm_cbe_tmp__719 = *((&GM.field10));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__718)) == llvm_cbe_tmp__719), ((&_OC_str7.array[((signed int )0u)])));
  llvm_cbe_tmp__720 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__574->field35)));
  llvm_cbe_tmp__721 = *((&GM.field9));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__720)) == llvm_cbe_tmp__721), ((&_OC_str8.array[((signed int )0u)])));
  llvm_cbe_tmp__722 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field2)));
  llvm_cbe_tmp__723 = *((&GM.field16));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__722)) == llvm_cbe_tmp__723), ((&_OC_str9.array[((signed int )0u)])));
  llvm_cbe_tmp__724 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field3)));
  llvm_cbe_tmp__725 = *((&GM.field17));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__724)) == llvm_cbe_tmp__725), ((&_OC_str10.array[((signed int )0u)])));
  llvm_cbe_tmp__726 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field4))))&1);
  llvm_cbe_tmp__727 = *((&GM.field18));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__726)) == llvm_cbe_tmp__727), ((&_OC_str23.array[((signed int )0u)])));
  llvm_cbe_tmp__728 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field9))))&1);
  llvm_cbe_tmp__729 = *((&GM.field24));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__728)) == llvm_cbe_tmp__729), ((&_OC_str11.array[((signed int )0u)])));
  llvm_cbe_tmp__730 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field7)));
  llvm_cbe_tmp__731 = *((&GM.field22));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__730)) == llvm_cbe_tmp__731), ((&_OC_str12.array[((signed int )0u)])));
  llvm_cbe_tmp__732 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field8)));
  llvm_cbe_tmp__733 = *((&GM.field23));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__732)) == llvm_cbe_tmp__733), ((&_OC_str13.array[((signed int )0u)])));
  llvm_cbe_tmp__734 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__574->field11)));
  llvm_cbe_tmp__735 = *((&GM.field1));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__734)) == llvm_cbe_tmp__735), ((&_OC_str14.array[((signed int )0u)])));
  llvm_cbe_tmp__736 = *(&rd_complete);
  llvm_cbe_tmp__737 = *((&GM.field15));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__736)) == llvm_cbe_tmp__737), ((&_OC_str15.array[((signed int )0u)])));
  llvm_cbe_tmp__738 = *(&llvm_cbe_index);
  llvm_cbe_tmp__739 = *((&GM.field4));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__738)) == llvm_cbe_tmp__739), ((&_OC_str16.array[((signed int )0u)])));
  llvm_cbe_tmp__740 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__741 = *((&GM.field6));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__740)) == llvm_cbe_tmp__741), ((&_OC_str17.array[((signed int )0u)])));
  llvm_cbe_tmp__742 = *(&upc);
  llvm_cbe_tmp__743 = *((&GM.field20));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__742)) == llvm_cbe_tmp__743), ((&_OC_str18.array[((signed int )0u)])));
  llvm_cbe_tmp__744 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field37))))&1);
  llvm_cbe_tmp__745 = *((&GM.field19));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__744)) == llvm_cbe_tmp__745), ((&_OC_str19.array[((signed int )0u)])));
  llvm_cbe_tmp__746 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__574->field38))))&1);
  llvm_cbe_tmp__747 = *((&GM.field13));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__746)) == llvm_cbe_tmp__747), ((&_OC_str20.array[((signed int )0u)])));
  llvm_cbe_tmp__748 = *((&GM.field0.field0));
  llvm_cbe_tmp__749 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__574->field20)), 0u);
  llvm_cbe_tmp__750 = ((__CPROVER_array_equal(llvm_cbe_tmp__748, llvm_cbe_tmp__749))&1);
  __CPROVER_assert(llvm_cbe_tmp__750, ((&_OC_str21.array[((signed int )0u)])));
  llvm_cbe_tmp__751 = *((&GM.field14.field0));
  llvm_cbe_tmp__752 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__574->field28)), 0u);
  llvm_cbe_tmp__753 = ((__CPROVER_array_equal(llvm_cbe_tmp__751, llvm_cbe_tmp__752))&1);
  __CPROVER_assert(llvm_cbe_tmp__753, ((&_OC_str22.array[((signed int )0u)])));
  goto llvm_cbe_tmp__758;
...
bool _ZN14sc_signal_boolaSERKb(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_d) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__763;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__764;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__765;
  unsigned char *llvm_cbe_tmp__766;
  unsigned char llvm_cbe_tmp__767;
  unsigned char llvm_cbe_tmp__768;

  *(&llvm_cbe_tmp__763) = llvm_cbe_this;
  *(&llvm_cbe_tmp__764) = llvm_cbe_d;
  llvm_cbe_tmp__765 = *(&llvm_cbe_tmp__763);
  llvm_cbe_tmp__766 = *(&llvm_cbe_tmp__764);
  llvm_cbe_tmp__767 = *llvm_cbe_tmp__766;
  *((&llvm_cbe_tmp__765->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__767&1u))&1))));
  llvm_cbe_tmp__768 = *((&llvm_cbe_tmp__765->field0));
  return (((((bool )llvm_cbe_tmp__768&1u))&1));
}


void _ZN13sc_signal_u325writeERKj(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned int *llvm_cbe_d) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__769;    /* Address-exposed local */
  unsigned int *llvm_cbe_tmp__770;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__771;
  unsigned int *llvm_cbe_tmp__772;
  unsigned int llvm_cbe_tmp__773;

  *(&llvm_cbe_tmp__769) = llvm_cbe_this;
  *(&llvm_cbe_tmp__770) = llvm_cbe_d;
  llvm_cbe_tmp__771 = *(&llvm_cbe_tmp__769);
  llvm_cbe_tmp__772 = *(&llvm_cbe_tmp__770);
  llvm_cbe_tmp__773 = *llvm_cbe_tmp__772;
  *((&llvm_cbe_tmp__771->field0)) = llvm_cbe_tmp__773;
  return;
}


unsigned short _ZN13sc_signal_u164readEv(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__774;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__775;
  unsigned short llvm_cbe_tmp__776;

  *(&llvm_cbe_tmp__774) = llvm_cbe_this;
  llvm_cbe_tmp__775 = *(&llvm_cbe_tmp__774);
  llvm_cbe_tmp__776 = *((&llvm_cbe_tmp__775->field0));
  return llvm_cbe_tmp__776;
}


unsigned char *_ZN11SysCArray2DIhLj2ELj512EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  unsigned char *llvm_cbe_tmp__777;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__778;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__779;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__780;
  ...
  *(&llvm_cbe_tmp__778) = llvm_cbe_this;
  *(&llvm_cbe_tmp__779) = llvm_cbe_Xidx;
  llvm_cbe_tmp__780 = *(&llvm_cbe_tmp__778);
  llvm_cbe_tmp__781 = *(&llvm_cbe_tmp__779);
  if ((llvm_cbe_tmp__781 == 0u)) {
...
llvm_cbe_tmp__786:
  llvm_cbe_tmp__782 = *((&llvm_cbe_tmp__780->field1));
  *(&llvm_cbe_tmp__777) = llvm_cbe_tmp__782;
  goto llvm_cbe_tmp__788;

llvm_cbe_tmp__787:
  llvm_cbe_tmp__783 = *(&llvm_cbe_tmp__779);
  llvm_cbe_tmp__784 = *((&llvm_cbe_tmp__780->field0));
  *(&llvm_cbe_tmp__777) = ((&llvm_cbe_tmp__784[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__783) * ((unsigned int )512u)))))))]));
  goto llvm_cbe_tmp__788;

llvm_cbe_tmp__788:
  llvm_cbe_tmp__785 = *(&llvm_cbe_tmp__777);
  return llvm_cbe_tmp__785;
}
...
unsigned char *_ZN11SysCArray2DIhLj2ELj128EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  ...
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__790;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__791;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__792;
  ...
  *(&llvm_cbe_tmp__790) = llvm_cbe_this;
  *(&llvm_cbe_tmp__791) = llvm_cbe_Xidx;
  llvm_cbe_tmp__792 = *(&llvm_cbe_tmp__790);
  llvm_cbe_tmp__793 = *(&llvm_cbe_tmp__791);
  if ((llvm_cbe_tmp__793 == 0u)) {
...
llvm_cbe_tmp__798:
  ...
  *(&llvm_cbe_tmp__789) = llvm_cbe_tmp__794;
  goto llvm_cbe_tmp__800;

llvm_cbe_tmp__799:
  llvm_cbe_tmp__795 = *(&llvm_cbe_tmp__791);
  llvm_cbe_tmp__796 = *((&llvm_cbe_tmp__792->field0));
  *(&llvm_cbe_tmp__789) = ((&llvm_cbe_tmp__796[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__795) * ((unsigned int )128u)))))))]));
  goto llvm_cbe_tmp__800;

llvm_cbe_tmp__800:
  llvm_cbe_tmp__797 = *(&llvm_cbe_tmp__789);
  return llvm_cbe_tmp__797;
}


void _ZN3rbm5storeEv(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__801;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__802;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__803;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__804;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__805;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__806;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__807;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__808;    /* Address-exposed local */
  ...
  unsigned char llvm_cbe_tmp__809;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__810;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__811;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__812;    /* Address-exposed local */
  unsigned int llvm_cbe_dma_index;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__813;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__814;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__815;    /* Address-exposed local */
  unsigned short llvm_cbe_i;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__816;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__817;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__818;
  bool llvm_cbe_tmp__819;
  bool llvm_cbe_tmp__820;
  unsigned short llvm_cbe_tmp__821;
  unsigned short llvm_cbe_tmp__822;
  unsigned int llvm_cbe_tmp__823;
  unsigned short llvm_cbe_tmp__824;
  bool llvm_cbe_tmp__825;
  bool llvm_cbe_tmp__826;
  unsigned short llvm_cbe_tmp__827;
  unsigned int llvm_cbe_tmp__828;
  unsigned short llvm_cbe_tmp__829;
  unsigned int llvm_cbe_tmp__830;
  bool llvm_cbe_tmp__831;
  unsigned short llvm_cbe_tmp__832;
  unsigned short llvm_cbe_tmp__833;
  unsigned short llvm_cbe_tmp__834;
  unsigned short llvm_cbe_tmp__835;
  unsigned char *llvm_cbe_tmp__836;
  unsigned char llvm_cbe_tmp__837;
  unsigned char llvm_cbe_tmp__838;
  unsigned short llvm_cbe_tmp__839;

  *(&llvm_cbe_tmp__801) = llvm_cbe_this;
  llvm_cbe_tmp__818 = *(&llvm_cbe_tmp__801);
  *(&llvm_cbe_tmp__802) = ((unsigned char )1);
  llvm_cbe_tmp__819 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__818->field36)), (&llvm_cbe_tmp__802)))&1);
  *(&llvm_cbe_tmp__803) = 0u;
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__818->field8)), (&llvm_cbe_tmp__803));
  *(&llvm_cbe_tmp__804) = 0u;
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__818->field7)), (&llvm_cbe_tmp__804));
  *(&llvm_cbe_tmp__805) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field9)), (&llvm_cbe_tmp__805));
  *(&llvm_cbe_tmp__806) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field44)), (&llvm_cbe_tmp__806));
  *(&llvm_cbe_tmp__807) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field45)), (&llvm_cbe_tmp__807));
  *(&llvm_cbe_tmp__808) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field12)), (&llvm_cbe_tmp__808));
  goto llvm_cbe_tmp__840;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__840:
  _Z4waitv();
  llvm_cbe_tmp__820 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__818->field36))))&1);
  if ((((llvm_cbe_tmp__820 ^ 1)&1))) {
    goto llvm_cbe_tmp__840;
  } else {
...
llvm_cbe_tmp__841:
  llvm_cbe_tmp__821 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__818->field34)));
  *(&llvm_cbe_ntu) = llvm_cbe_tmp__821;
  llvm_cbe_tmp__822 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__818->field35)));
  *(&llvm_cbe_nm) = llvm_cbe_tmp__822;
  *(&llvm_cbe_index) = 0u;
  goto llvm_cbe_tmp__842;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__842:
  llvm_cbe_tmp__823 = *(&llvm_cbe_index);
  llvm_cbe_tmp__824 = *(&llvm_cbe_ntu);
  if ((llvm_cbe_tmp__823 == (((unsigned int )(unsigned short )llvm_cbe_tmp__824)))) {
    goto llvm_cbe_tmp__843;
  } else {
    goto llvm_cbe_tmp__844;
  }

llvm_cbe_tmp__845:
  *(&llvm_cbe_tmp__817) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field45)), (&llvm_cbe_tmp__817));
  goto llvm_cbe_tmp__842;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__846:
  llvm_cbe_tmp__832 = *(&llvm_cbe_i);
  if ((((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__832))) < ((signed int )100u))) {
    goto llvm_cbe_tmp__847;
  } else {
    goto llvm_cbe_tmp__845;
  }

llvm_cbe_tmp__848:
  llvm_cbe_tmp__835 = *(&llvm_cbe_i);
  llvm_cbe_tmp__836 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__818->field28)), 0u);
  llvm_cbe_tmp__837 = *((&llvm_cbe_tmp__836[((signed long long )(((unsigned long long )(unsigned short )llvm_cbe_tmp__835)))]));
  *(&llvm_cbe_rating) = llvm_cbe_tmp__837;
  _Z4waitv();
  llvm_cbe_tmp__838 = *(&llvm_cbe_rating);
  *(&llvm_cbe_tmp__816) = (((unsigned int )(unsigned char )llvm_cbe_tmp__838));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__818->field11)), (&llvm_cbe_tmp__816));
  llvm_cbe_tmp__839 = *(&llvm_cbe_i);
  *(&llvm_cbe_i) = (((unsigned short )(((unsigned short )(((unsigned short )llvm_cbe_tmp__839) + ((unsigned short )((unsigned short )1)))))));
  goto llvm_cbe_tmp__846;

llvm_cbe_tmp__847:
  llvm_cbe_tmp__833 = *(&llvm_cbe_i);
  llvm_cbe_tmp__834 = *(&llvm_cbe_nm);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__833)) == (((unsigned int )(unsigned short )llvm_cbe_tmp__834)))) {
    goto llvm_cbe_tmp__845;
  } else {
    goto llvm_cbe_tmp__848;
  }

  } while (1); /* end of syntactic loop '' */
llvm_cbe_tmp__849:
  *(&llvm_cbe_tmp__815) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field9)), (&llvm_cbe_tmp__815));
  *(&llvm_cbe_i) = ((unsigned short )0);
  goto llvm_cbe_tmp__846;
...
llvm_cbe_tmp__850:
  _Z4waitv();
  llvm_cbe_tmp__831 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__818->field10))))&1);
  if ((((llvm_cbe_tmp__831 ^ 1)&1))) {
    goto llvm_cbe_tmp__850;
  } else {
    goto llvm_cbe_tmp__849;
  }

  } while (1); /* end of syntactic loop '' */
llvm_cbe_tmp__851:
  *(&llvm_cbe_tmp__811) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field44)), (&llvm_cbe_tmp__811));
  *(&llvm_cbe_tmp__812) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field45)), (&llvm_cbe_tmp__812));
  llvm_cbe_tmp__827 = *(&llvm_cbe_nm);
  llvm_cbe_tmp__828 = *(&llvm_cbe_index);
  *(&llvm_cbe_dma_index) = (((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__827))) * ((unsigned int )llvm_cbe_tmp__828))));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__818->field7)), (&llvm_cbe_dma_index));
  llvm_cbe_tmp__829 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__818->field35)));
  *(&llvm_cbe_tmp__813) = (((unsigned int )(unsigned short )llvm_cbe_tmp__829));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__818->field8)), (&llvm_cbe_tmp__813));
  llvm_cbe_tmp__830 = *(&llvm_cbe_index);
  *(&llvm_cbe_index) = (((unsigned int )(((unsigned int )llvm_cbe_tmp__830) + ((unsigned int )1u))));
  *(&llvm_cbe_tmp__814) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field9)), (&llvm_cbe_tmp__814));
  goto llvm_cbe_tmp__850;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__852:
  _Z4waitv();
  llvm_cbe_tmp__826 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__818->field43))))&1);
  if (llvm_cbe_tmp__826) {
    goto llvm_cbe_tmp__852;
  } else {
    goto llvm_cbe_tmp__851;
  }

  } while (1); /* end of syntactic loop '' */
llvm_cbe_tmp__853:
  *(&llvm_cbe_tmp__810) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field44)), (&llvm_cbe_tmp__810));
  goto llvm_cbe_tmp__852;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__844:
  _Z4waitv();
  llvm_cbe_tmp__825 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__818->field43))))&1);
  if ((((llvm_cbe_tmp__825 ^ 1)&1))) {
    goto llvm_cbe_tmp__844;
  } else {
...
llvm_cbe_tmp__843:
  *(&llvm_cbe_tmp__809) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__818->field12)), (&llvm_cbe_tmp__809));
  goto llvm_cbe_tmp__854;
...
void _ZN3rbmC1Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__855;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__856;

  *(&llvm_cbe_tmp__855) = llvm_cbe_this;
  llvm_cbe_tmp__856 = *(&llvm_cbe_tmp__855);
  _ZN3rbmC2Ev(llvm_cbe_tmp__856);
  return;
}
...
void _ZN8type_memIhLj65536EEC2ERKS0_(struct l_class_OC_SysCArray1D *llvm_cbe_this, struct l_class_OC_SysCArray1D *llvm_cbe_r) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__858;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__859;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__860;
  unsigned char *llvm_cbe_tmp__861;
  unsigned char *llvm_cbe_tmp__862;
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__863;
  unsigned char *llvm_cbe_tmp__864;

  *(&llvm_cbe_tmp__858) = llvm_cbe_this;
  *(&llvm_cbe_tmp__859) = llvm_cbe_r;
  llvm_cbe_tmp__860 = *(&llvm_cbe_tmp__858);
  llvm_cbe_tmp__861 = __CPROVER_malloc(65536ull);
  *((&llvm_cbe_tmp__860->field0)) = llvm_cbe_tmp__861;
  llvm_cbe_tmp__862 = *((&llvm_cbe_tmp__860->field0));
  llvm_cbe_tmp__863 = *(&llvm_cbe_tmp__859);
  llvm_cbe_tmp__864 = *((&llvm_cbe_tmp__863->field0));
  __CPROVER_array_copy(llvm_cbe_tmp__862, llvm_cbe_tmp__864);
  return;
}


void _ZN8type_memIhLj65536EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__865;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__866;

  *(&llvm_cbe_tmp__865) = llvm_cbe_this;
  llvm_cbe_tmp__866 = *(&llvm_cbe_tmp__865);
  return;
}


void _ZN3rbmC2Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__867;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__868;
  ...
  *(&llvm_cbe_tmp__867) = llvm_cbe_this;
  llvm_cbe_tmp__868 = *(&llvm_cbe_tmp__867);
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field0)), ((&_OC_str25.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field1)), ((&_OC_str26.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field2)), ((&_OC_str27.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field3)), ((&_OC_str28.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field4)), ((&_OC_str29.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field5)), ((&_OC_str30.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field6)), ((&_OC_str31.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field7)), ((&_OC_str32.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field8)), ((&_OC_str33.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field9)), ((&_OC_str34.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field10)), ((&_OC_str35.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field11)), ((&_OC_str36.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field12)), ((&_OC_str37.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__868->field13)), ((&_OC_str38.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field14)), ((&_OC_str39.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field15)), ((&_OC_str40.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field16)), ((&_OC_str41.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field17)), ((&_OC_str42.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field18)), ((&_OC_str43.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__868->field19)), ((&_OC_str44.array[((signed int )0u)])));
  _ZN11SysCArray2DIhLj2ELj512EEC1Ev(((&llvm_cbe_tmp__868->field20)));
  _ZN11SysCArray1DIbLj512EEC1Ev(((&llvm_cbe_tmp__868->field21)));
  _ZN11SysCArray1DIbLj128EEC1Ev(((&llvm_cbe_tmp__868->field22)));
  _ZN11SysCArray2DIfLj501ELj101EEC1Ev(((&llvm_cbe_tmp__868->field23)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__868->field24)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__868->field25)));
  _ZN11SysCArray1DIfLj5EEC1Ev(((&llvm_cbe_tmp__868->field26)));
  _ZN11SysCArray1DIbLj512EEC1Ev(((&llvm_cbe_tmp__868->field27)));
  _ZN11SysCArray2DIhLj2ELj128EEC1Ev(((&llvm_cbe_tmp__868->field28)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field30)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field31)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field32)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field33)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field34)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__868->field35)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field36)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field37)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field38)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field39)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field40)));
  _ZN15sc_signal_int32C1Ev(((&llvm_cbe_tmp__868->field41)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field42)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field43)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field44)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__868->field45)));
  llvm_cbe_tmp__869 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__868->field1)));
  llvm_cbe_tmp__870 = *llvm_cbe_tmp__869;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__870&1u))&1)))), 0);
  llvm_cbe_tmp__871 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__868->field1)));
  llvm_cbe_tmp__872 = *llvm_cbe_tmp__871;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__872&1u))&1)))), 0);
  llvm_cbe_tmp__873 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__868->field1)));
  llvm_cbe_tmp__874 = *llvm_cbe_tmp__873;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__874&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__875 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__868->field1)));
  llvm_cbe_tmp__876 = *llvm_cbe_tmp__875;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__876&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__877 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__868->field1)));
  llvm_cbe_tmp__878 = *llvm_cbe_tmp__877;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__878&1u))&1)))), 0);
  return;
}


void _ZN14sc_signal_boolC1EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__879;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__880;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__881;
  unsigned char *llvm_cbe_tmp__882;

  *(&llvm_cbe_tmp__879) = llvm_cbe_this;
  *(&llvm_cbe_tmp__880) = llvm_cbe_p;
  llvm_cbe_tmp__881 = *(&llvm_cbe_tmp__879);
  llvm_cbe_tmp__882 = *(&llvm_cbe_tmp__880);
  _ZN14sc_signal_boolC2EPKc(llvm_cbe_tmp__881, llvm_cbe_tmp__882);
  return;
}


void _ZN13sc_signal_u32C1EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__883;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__884;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__885;
  unsigned char *llvm_cbe_tmp__886;

  *(&llvm_cbe_tmp__883) = llvm_cbe_this;
  *(&llvm_cbe_tmp__884) = llvm_cbe_p;
  llvm_cbe_tmp__885 = *(&llvm_cbe_tmp__883);
  llvm_cbe_tmp__886 = *(&llvm_cbe_tmp__884);
  _ZN13sc_signal_u32C2EPKc(llvm_cbe_tmp__885, llvm_cbe_tmp__886);
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__887;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__888;

  *(&llvm_cbe_tmp__887) = llvm_cbe_this;
  llvm_cbe_tmp__888 = *(&llvm_cbe_tmp__887);
  _ZN11SysCArray2DIhLj2ELj512EEC2Ev(llvm_cbe_tmp__888);
  return;
}


void _ZN11SysCArray1DIbLj512EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__889;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__890;

  *(&llvm_cbe_tmp__889) = llvm_cbe_this;
  llvm_cbe_tmp__890 = *(&llvm_cbe_tmp__889);
  _ZN11SysCArray1DIbLj512EEC2Ev(llvm_cbe_tmp__890);
  return;
}


void _ZN11SysCArray1DIbLj128EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__891;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__892;

  *(&llvm_cbe_tmp__891) = llvm_cbe_this;
  llvm_cbe_tmp__892 = *(&llvm_cbe_tmp__891);
  _ZN11SysCArray1DIbLj128EEC2Ev(llvm_cbe_tmp__892);
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC1Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__893;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__894;

  *(&llvm_cbe_tmp__893) = llvm_cbe_this;
  llvm_cbe_tmp__894 = *(&llvm_cbe_tmp__893);
  _ZN11SysCArray2DIfLj501ELj101EEC2Ev(llvm_cbe_tmp__894);
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__895;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__896;

  *(&llvm_cbe_tmp__895) = llvm_cbe_this;
  llvm_cbe_tmp__896 = *(&llvm_cbe_tmp__895);
  _ZN11SysCArray2DIbLj501ELj101EEC2Ev(llvm_cbe_tmp__896);
  return;
}


void _ZN11SysCArray1DIfLj5EEC1Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__897;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__898;

  *(&llvm_cbe_tmp__897) = llvm_cbe_this;
  llvm_cbe_tmp__898 = *(&llvm_cbe_tmp__897);
  _ZN11SysCArray1DIfLj5EEC2Ev(llvm_cbe_tmp__898);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__899;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__900;

  *(&llvm_cbe_tmp__899) = llvm_cbe_this;
  llvm_cbe_tmp__900 = *(&llvm_cbe_tmp__899);
  _ZN11SysCArray2DIhLj2ELj128EEC2Ev(llvm_cbe_tmp__900);
  return;
}


void _ZN13sc_signal_u16C1Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__901;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__902;

  *(&llvm_cbe_tmp__901) = llvm_cbe_this;
  llvm_cbe_tmp__902 = *(&llvm_cbe_tmp__901);
  _ZN13sc_signal_u16C2Ev(llvm_cbe_tmp__902);
  return;
}


void _ZN14sc_signal_boolC1Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__903;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__904;

  *(&llvm_cbe_tmp__903) = llvm_cbe_this;
  llvm_cbe_tmp__904 = *(&llvm_cbe_tmp__903);
  _ZN14sc_signal_boolC2Ev(llvm_cbe_tmp__904);
  return;
}


void _ZN15sc_signal_int32C1Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__905;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__906;

  *(&llvm_cbe_tmp__905) = llvm_cbe_this;
  llvm_cbe_tmp__906 = *(&llvm_cbe_tmp__905);
  _ZN15sc_signal_int32C2Ev(llvm_cbe_tmp__906);
  return;
}


unsigned char *_ZN14sc_signal_boolcvRbEv(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__907;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__908;

  *(&llvm_cbe_tmp__907) = llvm_cbe_this;
  llvm_cbe_tmp__908 = *(&llvm_cbe_tmp__907);
  return ((&llvm_cbe_tmp__908->field0));
}


void _ZN15sc_signal_int32C2Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__909;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__910;

  *(&llvm_cbe_tmp__909) = llvm_cbe_this;
  llvm_cbe_tmp__910 = *(&llvm_cbe_tmp__909);
  return;
}


void _ZN14sc_signal_boolC2Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__911;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__912;

  *(&llvm_cbe_tmp__911) = llvm_cbe_this;
  llvm_cbe_tmp__912 = *(&llvm_cbe_tmp__911);
  return;
}


void _ZN13sc_signal_u16C2Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__913;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__914;

  *(&llvm_cbe_tmp__913) = llvm_cbe_this;
  llvm_cbe_tmp__914 = *(&llvm_cbe_tmp__913);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__915;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__916;
  ...
  *(&llvm_cbe_tmp__915) = llvm_cbe_this;
  ...
  llvm_cbe_tmp__917 = __CPROVER_malloc(256ull);
  *((&llvm_cbe_tmp__916->field0)) = llvm_cbe_tmp__917;
  llvm_cbe_tmp__918 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__916->field1)) = llvm_cbe_tmp__918;
  return;
}


void _ZN11SysCArray1DIfLj5EEC2Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__919;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__920;
  unsigned char *llvm_cbe_tmp__921;

  *(&llvm_cbe_tmp__919) = llvm_cbe_this;
  llvm_cbe_tmp__920 = *(&llvm_cbe_tmp__919);
  llvm_cbe_tmp__921 = __CPROVER_malloc(20ull);
  *((&llvm_cbe_tmp__920->field0)) = (((float *)llvm_cbe_tmp__921));
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__922;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__923;
  unsigned char *llvm_cbe_tmp__924;
  unsigned char *llvm_cbe_tmp__925;

  *(&llvm_cbe_tmp__922) = llvm_cbe_this;
  llvm_cbe_tmp__923 = *(&llvm_cbe_tmp__922);
  llvm_cbe_tmp__924 = __CPROVER_malloc(50601ull);
  *((&llvm_cbe_tmp__923->field0)) = llvm_cbe_tmp__924;
  llvm_cbe_tmp__925 = __CPROVER_malloc(101ull);
  *((&llvm_cbe_tmp__923->field1)) = llvm_cbe_tmp__925;
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC2Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__926;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__927;
  unsigned char *llvm_cbe_tmp__928;
  unsigned char *llvm_cbe_tmp__929;

  *(&llvm_cbe_tmp__926) = llvm_cbe_this;
  llvm_cbe_tmp__927 = *(&llvm_cbe_tmp__926);
  llvm_cbe_tmp__928 = __CPROVER_malloc(202404ull);
  *((&llvm_cbe_tmp__927->field0)) = (((float *)llvm_cbe_tmp__928));
  llvm_cbe_tmp__929 = __CPROVER_malloc(404ull);
  *((&llvm_cbe_tmp__927->field1)) = (((float *)llvm_cbe_tmp__929));
  return;
}


void _ZN11SysCArray1DIbLj128EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__930;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__931;
  unsigned char *llvm_cbe_tmp__932;

  *(&llvm_cbe_tmp__930) = llvm_cbe_this;
  llvm_cbe_tmp__931 = *(&llvm_cbe_tmp__930);
  llvm_cbe_tmp__932 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__931->field0)) = llvm_cbe_tmp__932;
  return;
}


void _ZN11SysCArray1DIbLj512EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__933;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__934;
  unsigned char *llvm_cbe_tmp__935;

  *(&llvm_cbe_tmp__933) = llvm_cbe_this;
  llvm_cbe_tmp__934 = *(&llvm_cbe_tmp__933);
  llvm_cbe_tmp__935 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__934->field0)) = llvm_cbe_tmp__935;
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__936;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__937;
  unsigned char *llvm_cbe_tmp__938;
  unsigned char *llvm_cbe_tmp__939;

  *(&llvm_cbe_tmp__936) = llvm_cbe_this;
  llvm_cbe_tmp__937 = *(&llvm_cbe_tmp__936);
  llvm_cbe_tmp__938 = __CPROVER_malloc(1024ull);
  *((&llvm_cbe_tmp__937->field0)) = llvm_cbe_tmp__938;
  llvm_cbe_tmp__939 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__937->field1)) = llvm_cbe_tmp__939;
  return;
}


void _ZN13sc_signal_u32C2EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__940;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__941;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__942;

  *(&llvm_cbe_tmp__940) = llvm_cbe_this;
  *(&llvm_cbe_tmp__941) = llvm_cbe_p;
  llvm_cbe_tmp__942 = *(&llvm_cbe_tmp__940);
  return;
}


void _ZN14sc_signal_boolC2EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__943;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__944;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__945;

  *(&llvm_cbe_tmp__943) = llvm_cbe_this;
  *(&llvm_cbe_tmp__944) = llvm_cbe_p;
  llvm_cbe_tmp__945 = *(&llvm_cbe_tmp__943);
  return;
}


void _ZN13model_computeD2Ev(struct l_class_OC_model_compute *llvm_cbe_this) {
  struct l_class_OC_model_compute *llvm_cbe_tmp__946;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__947;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__948;    /* Address-exposed local */
  struct l_class_OC_model_compute *llvm_cbe_tmp__949;

  *(&llvm_cbe_tmp__946) = llvm_cbe_this;
  llvm_cbe_tmp__949 = *(&llvm_cbe_tmp__946);
  _ZN8type_memIhLj128EED1Ev(((&llvm_cbe_tmp__949->field14)));
  _ZN8type_memIhLj65536EED1Ev(((&llvm_cbe_tmp__949->field3)));
  _ZN8type_memIhLj512EED1Ev(((&llvm_cbe_tmp__949->field0)));
  return;
}


void _ZN8type_memIhLj128EED1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__950;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__951;

  *(&llvm_cbe_tmp__950) = llvm_cbe_this;
  llvm_cbe_tmp__951 = *(&llvm_cbe_tmp__950);
  _ZN8type_memIhLj128EED2Ev(llvm_cbe_tmp__951);
  return;
}
...
void _ZN8type_memIhLj512EED1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  ...
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__953;

  *(&llvm_cbe_tmp__952) = llvm_cbe_this;
  llvm_cbe_tmp__953 = *(&llvm_cbe_tmp__952);
  _ZN8type_memIhLj512EED2Ev(llvm_cbe_tmp__953);
  return;
}


void _ZN8type_memIhLj512EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__954;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__955;

  *(&llvm_cbe_tmp__954) = llvm_cbe_this;
  llvm_cbe_tmp__955 = *(&llvm_cbe_tmp__954);
  return;
}
...
void _ZN8type_memIhLj128EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  ...
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__957;

  *(&llvm_cbe_tmp__956) = llvm_cbe_this;
  llvm_cbe_tmp__957 = *(&llvm_cbe_tmp__956);
  return;
}


void _ZN13model_computeC2Ev(struct l_class_OC_model_compute *llvm_cbe_this) {
  struct l_class_OC_model_compute *llvm_cbe_tmp__958;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__959;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__960;    /* Address-exposed local */
  struct l_class_OC_model_compute *llvm_cbe_tmp__961;

  *(&llvm_cbe_tmp__958) = llvm_cbe_this;
  llvm_cbe_tmp__961 = *(&llvm_cbe_tmp__958);
  _ZN8type_memIhLj512EEC1El(((&llvm_cbe_tmp__961->field0)), 0ull);
  _ZN8type_memIhLj65536EEC1El(((&llvm_cbe_tmp__961->field3)), 0ull);
  _ZN8type_memIhLj128EEC1El(((&llvm_cbe_tmp__961->field14)), 0ull);
  *((&llvm_cbe_tmp__961->field25)) = 65535ull;
  *((&llvm_cbe_tmp__961->field26)) = 4294967295ull;
  return;
}


void _ZN8type_memIhLj512EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__962;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__963;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__964;
  unsigned long long llvm_cbe_tmp__965;

  *(&llvm_cbe_tmp__962) = llvm_cbe_this;
  *(&llvm_cbe_tmp__963) = llvm_cbe_def;
  llvm_cbe_tmp__964 = *(&llvm_cbe_tmp__962);
  llvm_cbe_tmp__965 = *(&llvm_cbe_tmp__963);
  _ZN8type_memIhLj512EEC2El(llvm_cbe_tmp__964, llvm_cbe_tmp__965);
  return;
}


void _ZN8type_memIhLj65536EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__966;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__967;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__968;
  unsigned long long llvm_cbe_tmp__969;

  *(&llvm_cbe_tmp__966) = llvm_cbe_this;
  *(&llvm_cbe_tmp__967) = llvm_cbe_def;
  llvm_cbe_tmp__968 = *(&llvm_cbe_tmp__966);
  llvm_cbe_tmp__969 = *(&llvm_cbe_tmp__967);
  _ZN8type_memIhLj65536EEC2El(llvm_cbe_tmp__968, llvm_cbe_tmp__969);
  return;
}


void _ZN8type_memIhLj128EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__970;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__971;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__972;
  unsigned long long llvm_cbe_tmp__973;

  *(&llvm_cbe_tmp__970) = llvm_cbe_this;
  *(&llvm_cbe_tmp__971) = llvm_cbe_def;
  llvm_cbe_tmp__972 = *(&llvm_cbe_tmp__970);
  llvm_cbe_tmp__973 = *(&llvm_cbe_tmp__971);
  _ZN8type_memIhLj128EEC2El(llvm_cbe_tmp__972, llvm_cbe_tmp__973);
  return;
}


void _ZN8type_memIhLj128EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__974;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__975;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__976;
  unsigned char *llvm_cbe_tmp__977;

  *(&llvm_cbe_tmp__974) = llvm_cbe_this;
  *(&llvm_cbe_tmp__975) = llvm_cbe_def;
  llvm_cbe_tmp__976 = *(&llvm_cbe_tmp__974);
  llvm_cbe_tmp__977 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__976->field0)) = llvm_cbe_tmp__977;
  return;
}


void _ZN8type_memIhLj65536EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__978;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__979;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__980;
  unsigned char *llvm_cbe_tmp__981;

  *(&llvm_cbe_tmp__978) = llvm_cbe_this;
  *(&llvm_cbe_tmp__979) = llvm_cbe_def;
  llvm_cbe_tmp__980 = *(&llvm_cbe_tmp__978);
  llvm_cbe_tmp__981 = __CPROVER_malloc(65536ull);
  *((&llvm_cbe_tmp__980->field0)) = llvm_cbe_tmp__981;
  return;
}


void _ZN8type_memIhLj512EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__982;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__983;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__984;
  unsigned char *llvm_cbe_tmp__985;

  *(&llvm_cbe_tmp__982) = llvm_cbe_this;
  *(&llvm_cbe_tmp__983) = llvm_cbe_def;
  llvm_cbe_tmp__984 = *(&llvm_cbe_tmp__982);
  llvm_cbe_tmp__985 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__984->field0)) = llvm_cbe_tmp__985;
  return;
}

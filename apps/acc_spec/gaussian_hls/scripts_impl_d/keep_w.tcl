...
#prove -all
#save -jdb $EXP/wri_out_C1.jdb -capture_setup -capture_session_data
#assume -disable {::Subset - C1}

#assume -enable {::Subset - C2}
#prove -all
#save -jdb $EXP/wri_out_C2.jdb -capture_setup -capture_session_data
#assume -disable {::Subset - C2}

#assume -enable {::Subset - D}
#prove -all
#save -jdb $EXP/wri_out_D.jdb -capture_setup -capture_session_data
#assume -disable {::Subset - D}

#assume -enable {::Subset - E}
#prove -all
#save -jdb $EXP/wri_out_E.jdb -capture_setup -capture_session_data
#assume -disable {::Subset - E}

/// \file Source for Verilog Verification Targets Generation (single target) assumption and assertion handling
/// generic case -- JasperGold has its override
// --- Hongce Zhang
...
void VlgSglTgtGen::add_wire_assign_assumption(
...
void VlgSglTgtGen::add_reg_cassign_assumption(

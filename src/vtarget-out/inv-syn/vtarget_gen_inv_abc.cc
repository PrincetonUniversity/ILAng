...
void VlgSglTgtGen_Abc::add_wire_assign_assumption(
...
void VlgSglTgtGen_Abc::add_reg_cassign_assumption(
...
/// Add an assumption
void VlgSglTgtGen_Abc::add_an_assumption(const std::string& aspt,
                                          const std::string& dspt) {
...
/// Add an assertion
void VlgSglTgtGen_Abc::add_an_assertion(const std::string& asst,
                                         const std::string& dspt) {
...
void VlgSglTgtGen_Abc::PreExportProcess() {
  ...
  for (auto&& pbname_prob_pair : _problems.assumptions) {
    ...
    ILA_DLOG("VlgSglTgtGen_Abc.PreExportProcess") << "Adding assumption:" << prbname;
...
void VlgSglTgtGen_Abc::generate_blif(

...
clang -emit-llvm -S -std=c11 -I $SMACK_LIB/include -UFAB_LOCK -UCTX_LOCK -UINT_LOCK -UMEM_CHECK $FW_SRC/*.c
mv *.ll $LLVM_SRC
...
#smack --pthread --context-bound 4 --unroll 2 --bit-precise -v --time-limit 0 $REP_BPL #-w err.log

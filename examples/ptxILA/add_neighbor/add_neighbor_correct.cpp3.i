# 1 "add_neighbor_correct.cudafe2.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
...
__attribute__((global)) __attribute__((__used__)) extern void _Z13add_neighbourPii(int *, int);
...
# 13 "add_neighbor_correct.cu"
__attribute__((global)) __attribute__((__used__)) void _Z13add_neighbourPii(
# 13 "add_neighbor_correct.cu"
int *A,
# 13 "add_neighbor_correct.cu"
int offset){

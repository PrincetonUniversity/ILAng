...
assert -name {bound - ila} { counter == 16 |-> ila_complete == 1 } -update_db;
assert -name {bound - hls} { counter == 16 |-> hls_step == 0 } -update_db;
assert -name {fix point entry - ila} { (counter > 16 & counter < 40) |-> ila_complete == 1 } -update_db;
assert -name {fix point entry - hls} { (counter > 16 & counter < 40) |-> hls_step == 0 } -update_db;
...
{ (counter == 16 & ila_arg_0_TVALID == 1 & hls_arg_0_TVALID == 1) |-> ( \

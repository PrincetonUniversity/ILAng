...
extern BIT_VEC aes(BIT_VEC cppVar_14, BIT_VEC cppVar_15, BIT_VEC cppVar_16);
class model_aes
{
public:
	model_aes() {
...
public:
	...
	BIT_VEC cppUpdateFun_blk_cnt(BIT_VEC cmd, BIT_VEC cmdaddr, BIT_VEC cmddata);
	...
	BIT_VEC cppUpdateFun_oped_byte_cnt(BIT_VEC cmd, BIT_VEC cmdaddr, BIT_VEC cmddata);

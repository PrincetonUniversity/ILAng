...
class ptxGPUModel(object):
    ...
    def add_assumptions(self):
        ...
        self.imply_rega = self.model.getreg('s7_0')
        self.imply_regb = self.model.getreg('s10_0')
        self.imply_result_addra = self.model.getreg('s6_0')
        self.imply_result_addrb = self.model.getreg('s9_0')
...
print ptx.model.bmcInit(ptx.predicate_bit == ila.bool(True), 26, True)

...
(rule (let ((a!1 (and (HW_REG_WRITE_chr@entry
    ...
    (rel.delta_fe01 cmd cmdaddr sha_state_1 b54)
    b54
    (rel.N_fe01_XRAM_nxt XRAM_1 XRAM_nxt)
    (rel.N_fe01_sha_state_nxt sha_state_1 sha_state_nxt)
    (rel.N_fe01_sha_rdaddr_nxt sha_rdaddr_1 sha_rdaddr_nxt)
    (rel.N_fe01_sha_wraddr_nxt sha_wraddr_1 sha_wraddr_nxt)
    (rel.N_fe01_sha_len_nxt sha_len_1 sha_len_nxt)
    (rel.N_fe01_sha_bytes_read_nxt sha_bytes_read_1 sha_bytes_read_nxt)
    ;

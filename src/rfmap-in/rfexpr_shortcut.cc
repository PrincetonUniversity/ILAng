...
rfmap::RfExpr rfmap_and(const rfmap::RfExpr &l, const rfmap::RfExpr &r) {
  return verilog_expr::VExprAst::MakeBinaryAst(verilog_expr::voperator::L_AND, l, r);
}

rfmap::RfExpr rfmap_or(const rfmap::RfExpr &l, const rfmap::RfExpr &r) {
  return verilog_expr::VExprAst::MakeBinaryAst(verilog_expr::voperator::L_OR, l, r);
}
...
rfmap::RfExpr rfmap_eq(const rfmap::RfExpr &l, const rfmap::RfExpr &r) {
  return verilog_expr::VExprAst::MakeBinaryAst(verilog_expr::voperator::L_EQ, l, r);
}

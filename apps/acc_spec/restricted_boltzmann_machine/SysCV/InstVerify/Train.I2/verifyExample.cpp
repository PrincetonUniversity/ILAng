...
__train_i2__END:
       ...
       __CPROVER_assert( init_done.read() ==  GM.init_done , "init_done_match");
		 ...
		 __CPROVER_assert( (((unsigned int) (max*2.0)) & 0xffff) == ( GM.train_max & 0xffff )  , "train_max_match");
...
__train_i2__START:
		...
		train_upc = 1;
		 ...
		 h = GM.train_h_cnt;
       if(j==0)
         max = ( GM.train_max & 0xffff ) / 2.0 - 31.0;
       else

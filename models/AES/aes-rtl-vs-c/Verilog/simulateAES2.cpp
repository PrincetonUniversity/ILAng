...
void assignUAesCtr()
{
	top->simXramAes_top__DOT__aes_top1__DOT__uaes_ctr_next[0] = aes_time[3]  << 24 | aes_time[2] << 16 | aes_time[1] << 8 | aes_time[0];
	top->simXramAes_top__DOT__aes_top1__DOT__uaes_ctr_next[1] = aes_time[7]  << 24 + aes_time[6] << 16+ aes_time[5] << 8 +aes_time[4];
	top->simXramAes_top__DOT__aes_top1__DOT__uaes_ctr_next[2] = aes_time[11]  << 24 + aes_time[10] << 16+ aes_time[9] << 8 +aes_time[8];
	top->simXramAes_top__DOT__aes_top1__DOT__uaes_ctr_next[3] = aes_time[15]  << 24 + aes_time[14] << 16+ aes_time[13] << 8 +aes_time[12];
}

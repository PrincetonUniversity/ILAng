...
%Instruction-level abstraction (ILA) models firmware visible behaviors of hardware
%modules. 
...
abstraction.
%With the extension of hierarchical ILA, an ILA is now defined as 
...
% Some textual execution semantics for the ILA/child-ILA interaction.

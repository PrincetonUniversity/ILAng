...
# 19
(cudaConfigureCall(blockPerGrid, threadsPerBlock)) ? (void)0 : (add_neighbour)(devA, 1); 
# 20
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__26_add_neighbor_error_cpp1_ii_98686d1f
# 1 "add_neighbor_error.cudafe1.stub.c"
#include "add_neighbor_error.cudafe1.stub.c"
# 1 "add_neighbor_error.cudafe1.stub.c"

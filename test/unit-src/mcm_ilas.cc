...
namespace ila {
  ...
  InstrLvlAbsPtr McmIlaGen::GetIlaMultiInstLinearSimp()
  {
    ...
    auto instr_1 = ila->NewInstr("pc-0:INC r1");
    {
      auto decode = ExprFuse::Eq(pc, ExprFuse::BvConst(0,8) );
      instr_1->set_decode(decode);
      instr_1->set_update(regs[1], ExprFuse::Add(regs[1] , ExprFuse::BvConst(1,8) ) );
    ...
    auto instr_2 = ila->NewInstr("pc-1:DEC r1");
    {
      ...
      instr_2->set_update(regs[1], ExprFuse::Sub(regs[1] , ExprFuse::BvConst(1,8) ) );
  ...
  InstrLvlAbsPtr McmIlaGen::GetIlaMultiInstCcSimp()
  {
    ...
    auto instr_1 = ila->NewInstr("pc-0:INC r1");
    {
      auto decode = ExprFuse::Eq(pc, ExprFuse::BvConst(0,8) );
      instr_1->set_decode(decode);
      instr_1->set_update(regs[1], ExprFuse::Add(regs[0] , ExprFuse::BvConst(1,8) ) );
    }
    ...
    auto instr_2 = ila->NewInstr("pc-0:DEC r1");
    {
      auto decode = ExprFuse::Eq(pc, ExprFuse::BvConst(0,8) );
      instr_2->set_decode(decode);
      instr_2->set_update(regs[1], ExprFuse::Sub(regs[0] , ExprFuse::BvConst(1,8) ) );
    }
...
#define REG_VAL(x) ExprFuse::Ite( ExprFuse::Eq((x), ExprFuse::BvConst(3,2)) , regs[3] , \
                   ExprFuse::Ite( ExprFuse::Eq((x), ExprFuse::BvConst(2,2)) , regs[2] , \
                   ExprFuse::Ite( ExprFuse::Eq((x), ExprFuse::BvConst(1,2)) , regs[1] , \
                   ExprFuse::Ite( ExprFuse::Eq((x), ExprFuse::BvConst(0,2)) , regs[0] , regs[0]\
                    ))))
...
#define UPDATE_R(val, inst) do { \
  ...
  InstrLvlAbsPtr McmIlaGen::GetIlaOneInstPcDecode(const std::string & ila_name, bool initRegs)
  {
    // parameters

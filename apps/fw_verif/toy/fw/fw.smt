...
(rule (let ((a!1 (and (writecWrap@_1 error.flag_0
                               ...
                               @acc_ptr_0)
                (not error.flag_0)
                (= writecWrap@%_3_0 (+ @acc_ptr_0 (* 0 12) 0))
...
(rule (let ((a!1 (and (writecWrap@_5 error.flag_0
                               ...
                               @acc_ptr_0)
                (not error.flag_0)
                (= writecWrap@%_6_0 (+ @acc_ptr_0 (* 0 12) 1))
...
(rule (let ((a!1 (= startAcc@%_3_0 (+ (+ @acc_ptr_0 (* 0 12)) 0)))
      (a!2 (= startAcc@%_5_0 (+ (+ @acc_ptr_0 (* 0 12)) 1))))
...
(rule (let ((a!1 (and (startAcc@_7 error.flag_0
                             ...
                             startAcc@%_call1_0)
                (not error.flag_0)
                (= startAcc@%_call2_0 (+ @acc_ptr_0 (* 0 12) 1))
...
(rule (let ((a!1 (and (main@_1 error.flag_0 @nd_0 main@%_2_0)
                ...
                (= main@%_call1_0 (+ @acc_ptr_0 (* 0 12) 1))
...
(rule (let ((a!1 (and (main@_11 error.flag_0 @acc_ptr_0 @nd_0 main@%_2_0)
                (not error.flag_0)
                (startAcc true
                          error.flag_0
                          error.flag_1
                          ...
                          main@%_call4_0
                          @acc_ptr_0)
                (= main@%_call5_0 (+ @acc_ptr_0 (* 0 12) 1))
                (or (<= @acc_ptr_0 0) (> main@%_call5_0 0))
                (> @acc_ptr_0 0)
                (= main@%_14_0 (select main@%_call4_0 main@%_call5_0))
                (= main@%_15_0 main@%_14_0)
                (= main@%_br6_0 (= main@%_15_0 0))
                (or error.flag_1 main@%_br6_0))))
  (=> a!1 (main@_18 error.flag_1 @nd_0))))
(rule (let ((a!1 (and (main@_11 error.flag_0 @acc_ptr_0 @nd_0 main@%_2_0)
                (not error.flag_0)
                (startAcc true
                          error.flag_0
  ...
  (=> a!1 (main@_call7 error.flag_1))))
(rule (=> (and (main@_call7 error.flag_0)
         (not error.flag_0)
         (verifier.error true error.flag_0 error.flag_1))
    (main@UnifiedUnreachableBlock error.flag_1)))
(rule (let ((a!1 (and (main@_18 error.flag_0 @nd_0)
                (not error.flag_0)
                (= main@%_19_0 @nd_0)
                (= main@%_br8_0 (not (= main@%_20_0 0)))
...
(rule (=> (and (main@_18 error.flag_0 @nd_0) error.flag_0)
    (main@_call10 error.flag_0)))

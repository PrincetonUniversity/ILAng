...
(define-fun |wrapper#5| ((state |wrapper_s|)) Bool (= (|wrapper#4| state) #b0010)) ; $eq$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:42$1_Y
(define-fun |wrapper#7| ((state |wrapper_s|)) Bool (= (|wrapper#6| state) #b0010)) ; $eq$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:43$3_Y
(define-fun |wrapper#8| ((state |wrapper_s|)) Bool (and (or  (|wrapper#5| state) false) (or  (|wrapper#7| state) false))) ; $logic_and$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:43$4_Y
...
(define-fun |wrapper#11| ((state |wrapper_s|)) (_ BitVec 4) (bvsub #b1111 (|wrapper#4| state))) ; $techmap\m1.$sub$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:78$11_Y
...
(define-fun |wrapper_a 0| ((state |wrapper_s|)) Bool (or (= ((_ extract 0 0) (|wrapper#9| state)) #b1) (not true))) ; $assert$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:53$6
(define-fun |wrapper#14| ((state |wrapper_s|)) (_ BitVec 4) (bvadd (|wrapper#6| state) #b0001)) ; $techmap\m1.$add$/home/hongce/ila/ila-stable/test/unit-data/inv_syn/cnt2-cex/inv-syn/wrapper.v:68$8_Y
...
(define-fun |wrapper_i| ((state |wrapper_s|)) Bool (and
  (= (|wrapper#4| state) #b1111) ; m1.imp
  (= (|wrapper#6| state) #b0000) ; m1.v
))

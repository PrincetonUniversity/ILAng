...
LOAD_INITIAL_WHILE:
   ...
   u16 tmp1, tmp2;
		...
		goto __compute_StartRead__START;
 
   
__compute_StartRead__START:
		...
		// *** END of LABEL: @compute.StartRead@START
...
// edges is ignored for FixPoint
		return;
		// *** END of LABEL: @compute.StartRead@END

...
static void __cxx_global_var_init18(void);
...
static struct l_unnamed1 _OC_str23;
static struct l_unnamed13 _OC_str24;
static struct l_unnamed15 _OC_str25;
static struct l_unnamed13 _OC_str26;
static struct l_unnamed14 _OC_str27;
static struct l_unnamed1 _OC_str28;
static struct l_unnamed13 _OC_str29;
static struct l_unnamed13 _OC_str30;
static struct l_unnamed16 _OC_str31;
static struct l_unnamed14 _OC_str32;
static struct l_unnamed0 _OC_str33;
static struct l_unnamed8 _OC_str34;
static struct l_unnamed2 _OC_str35;
static struct l_unnamed2 _OC_str36;
static struct l_unnamed17 _OC_str37;
static struct l_unnamed0 _OC_str38;
...
static struct l_unnamed8 _OC_str11 = { "wr_request_match" };
...
static struct l_unnamed12 _OC_str17 = { "123" };
struct l_struct_OC_rbm IMPL;
static struct l_unnamed12 _OC_str19 = { "clk" };
static struct l_unnamed12 _OC_str20 = { "rst" };
static struct l_unnamed13 _OC_str21 = { "rd_index" };
static struct l_unnamed14 _OC_str22 = { "rd_length" };
static struct l_unnamed1 _OC_str23 = { "rd_request" };
static struct l_unnamed13 _OC_str24 = { "rd_grant" };
static struct l_unnamed15 _OC_str25 = { "data_in" };
static struct l_unnamed13 _OC_str26 = { "wr_index" };
static struct l_unnamed14 _OC_str27 = { "wr_length" };
static struct l_unnamed1 _OC_str28 = { "wr_request" };
static struct l_unnamed13 _OC_str29 = { "wr_grant" };
static struct l_unnamed13 _OC_str30 = { "data_out" };
static struct l_unnamed16 _OC_str31 = { "done" };
static struct l_unnamed14 _OC_str32 = { "cond_done" };
static struct l_unnamed0 _OC_str33 = { "conf_num_hidden" };
static struct l_unnamed8 _OC_str34 = { "conf_num_visible" };
static struct l_unnamed2 _OC_str35 = { "conf_num_users" };
static struct l_unnamed2 _OC_str36 = { "conf_num_loops" };
static struct l_unnamed17 _OC_str37 = { "conf_num_testusers" };
static struct l_unnamed0 _OC_str38 = { "conf_num_movies" };
...
void _ZN3rbm4loadEv(struct l_struct_OC_rbm *llvm_cbe_this) {
  ...
  unsigned short llvm_cbe_tmp__911;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__912;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__913;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__914;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__915;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__916;    /* Address-exposed local */
  ...
  unsigned int llvm_cbe_tmp__917;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__918;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__919;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__920;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__921;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__922;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__923;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__924;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__925;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__926;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__927;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__928;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__929;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__930;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__931;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__932;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__933;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__934;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__935;    /* Address-exposed local */
  unsigned short llvm_cbe_i;    /* Address-exposed local */
  unsigned char llvm_cbe_rate;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__936;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__937;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__938;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__939;    /* Address-exposed local */
  unsigned int llvm_cbe_dma_index;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__940;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__941;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__942;    /* Address-exposed local */
  unsigned short llvm_cbe_i1;    /* Address-exposed local */
  unsigned char llvm_cbe_rate2;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__943;
  bool llvm_cbe_tmp__944;
  bool llvm_cbe_tmp__945;
  unsigned long long llvm_cbe_tmp__946;
  ...
  unsigned short llvm_cbe_tmp__952;
  unsigned short llvm_cbe_tmp__953;
  unsigned short llvm_cbe_tmp__954;
  unsigned short llvm_cbe_tmp__955;
  unsigned short llvm_cbe_tmp__956;
  unsigned short llvm_cbe_tmp__957;
  ...
  unsigned long long llvm_cbe_tmp__982;
  ...
  unsigned long long llvm_cbe_tmp__1034;
  ...
  bool llvm_cbe_tmp__1045;
  unsigned char *llvm_cbe_tmp__1046;
  unsigned char *llvm_cbe_tmp__1047;
  bool llvm_cbe_tmp__1048;
  unsigned int llvm_cbe_tmp__1049;
  unsigned char llvm_cbe_tmp__1050;
  unsigned char *llvm_cbe_tmp__1051;
  unsigned short llvm_cbe_tmp__1052;
  unsigned int llvm_cbe_tmp__1053;
  bool llvm_cbe_tmp__1054;
  bool llvm_cbe_tmp__1055;
  bool llvm_cbe_tmp__1056;
  bool llvm_cbe_tmp__1057;
  unsigned short llvm_cbe_tmp__1058;
  unsigned short llvm_cbe_tmp__1059;
  unsigned int llvm_cbe_tmp__1060;
  unsigned short llvm_cbe_tmp__1061;
  unsigned int llvm_cbe_tmp__1062;
  unsigned short llvm_cbe_tmp__1063;
  unsigned short llvm_cbe_tmp__1064;
  unsigned int llvm_cbe_tmp__1065;
  unsigned short llvm_cbe_tmp__1066;
  unsigned int llvm_cbe_tmp__1067;
  unsigned int llvm_cbe_tmp__1068;
  unsigned short llvm_cbe_tmp__1069;
  unsigned short llvm_cbe_tmp__1070;
  unsigned int llvm_cbe_tmp__1071;
  unsigned int llvm_cbe_tmp__1072;
  unsigned int llvm_cbe_tmp__1073;
  unsigned int llvm_cbe_tmp__1074;
  unsigned int llvm_cbe_tmp__1075;
  unsigned short llvm_cbe_tmp__1076;
  unsigned int llvm_cbe_tmp__1077;
  bool llvm_cbe_tmp__1078;
  bool llvm_cbe_tmp__1079;
  unsigned short llvm_cbe_tmp__1080;
  unsigned int llvm_cbe_tmp__1081;
  unsigned short llvm_cbe_tmp__1082;
  unsigned short llvm_cbe_tmp__1083;
  unsigned short llvm_cbe_tmp__1084;
  unsigned short llvm_cbe_tmp__1085;
  unsigned short llvm_cbe_tmp__1086;
  unsigned int llvm_cbe_tmp__1087;
  unsigned int llvm_cbe_tmp__1088;
  unsigned char llvm_cbe_tmp__1089;
  unsigned short llvm_cbe_tmp__1090;
  unsigned char llvm_cbe_tmp__1091;
  unsigned char *llvm_cbe_tmp__1092;
  unsigned short llvm_cbe_tmp__1093;
  ...
  *(&llvm_cbe_tmp__904) = llvm_cbe_this;
  llvm_cbe_tmp__943 = *(&llvm_cbe_tmp__904);
  *(&llvm_cbe_tmp__905) = ((unsigned char )1);
  llvm_cbe_tmp__944 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__943->field36)), (&llvm_cbe_tmp__905)))&1);
  *(&llvm_cbe_tmp__906) = 0u;
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field2)), (&llvm_cbe_tmp__906));
  *(&llvm_cbe_tmp__907) = 0u;
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field3)), (&llvm_cbe_tmp__907));
  *(&llvm_cbe_tmp__908) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__908));
  *(&llvm_cbe_tmp__909) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field37)), (&llvm_cbe_tmp__909));
  *(&llvm_cbe_tmp__910) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field38)), (&llvm_cbe_tmp__910));
  goto llvm_cbe_tmp__1097;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1097:
  _Z4waitv();
  llvm_cbe_tmp__945 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field36))))&1);
  if ((((llvm_cbe_tmp__945 ^ 1)&1))) {
    goto llvm_cbe_tmp__1097;
  } else {
...
llvm_cbe_tmp__1098:
  llvm_cbe_tmp__946 = *((&GM.field4));
  *(&llvm_cbe_tmp__911) = (((unsigned short )llvm_cbe_tmp__946));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field30)), (&llvm_cbe_tmp__911));
  llvm_cbe_tmp__947 = *((&GM.field9));
  *(&llvm_cbe_tmp__912) = (((unsigned short )llvm_cbe_tmp__947));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field31)), (&llvm_cbe_tmp__912));
  llvm_cbe_tmp__948 = *((&GM.field8));
  *(&llvm_cbe_tmp__913) = (((unsigned short )llvm_cbe_tmp__948));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field32)), (&llvm_cbe_tmp__913));
  llvm_cbe_tmp__949 = *((&GM.field5));
  *(&llvm_cbe_tmp__914) = (((unsigned short )llvm_cbe_tmp__949));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field33)), (&llvm_cbe_tmp__914));
  llvm_cbe_tmp__950 = *((&GM.field7));
  *(&llvm_cbe_tmp__915) = (((unsigned short )llvm_cbe_tmp__950));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field34)), (&llvm_cbe_tmp__915));
  llvm_cbe_tmp__951 = *((&GM.field6));
  *(&llvm_cbe_tmp__916) = (((unsigned short )llvm_cbe_tmp__951));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field35)), (&llvm_cbe_tmp__916));
  llvm_cbe_tmp__952 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field31)));
  *(&llvm_cbe_nv) = (((unsigned int )(unsigned short )llvm_cbe_tmp__952));
  llvm_cbe_tmp__953 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field34)));
  *(&llvm_cbe_ntu) = (((unsigned int )(unsigned short )llvm_cbe_tmp__953));
  llvm_cbe_tmp__954 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field32)));
  *(&llvm_cbe_nu) = (((unsigned int )(unsigned short )llvm_cbe_tmp__954));
  llvm_cbe_tmp__955 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field33)));
  *(&llvm_cbe_nlp) = (((unsigned int )(unsigned short )llvm_cbe_tmp__955));
  llvm_cbe_tmp__956 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field35)));
  *(&llvm_cbe_nm) = (((unsigned int )(unsigned short )llvm_cbe_tmp__956));
  *(&llvm_cbe_index) = ((unsigned short )0);
  *(&llvm_cbe_loop_count) = ((unsigned short )0);
  *(&llvm_cbe_pingpong) = ((unsigned char )0);
  llvm_cbe_tmp__957 = *(&llvm_cbe_index);
  *(&llvm_cbe_tmp__917) = (((unsigned int )(unsigned short )llvm_cbe_tmp__957));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field2)), (&llvm_cbe_tmp__917));
  llvm_cbe_tmp__958 = *(&llvm_cbe_nm);
  *(&llvm_cbe_tmp__918) = (((unsigned int )(((unsigned int )5u) * ((unsigned int )llvm_cbe_tmp__958))));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field3)), (&llvm_cbe_tmp__918));
  goto llvm_cbe_tmp__1099;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1099:
  *(&rd_grant_inp) = ((unsigned char )1);
  *(&llvm_cbe_tmp__919) = ((unsigned char )1);
  llvm_cbe_tmp__959 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__919)))&1);
  *((&GM.field15)) = 1ull;
  llvm_cbe_tmp__960 = *(&conf_done_inp);
  *((&((&llvm_cbe_tmp__943->field13))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__960&1u))&1))));
  llvm_cbe_tmp__961 = *(&conf_num_hidden_inp);
  *((&((&llvm_cbe_tmp__943->field14))->field0)) = llvm_cbe_tmp__961;
  llvm_cbe_tmp__962 = *(&conf_num_visible_inp);
  *((&((&llvm_cbe_tmp__943->field15))->field0)) = llvm_cbe_tmp__962;
  llvm_cbe_tmp__963 = *(&conf_num_users_inp);
  *((&((&llvm_cbe_tmp__943->field16))->field0)) = llvm_cbe_tmp__963;
  llvm_cbe_tmp__964 = *(&conf_num_loops_inp);
  *((&((&llvm_cbe_tmp__943->field17))->field0)) = llvm_cbe_tmp__964;
  llvm_cbe_tmp__965 = *(&conf_num_testusers_inp);
  *((&((&llvm_cbe_tmp__943->field18))->field0)) = llvm_cbe_tmp__965;
  llvm_cbe_tmp__966 = *(&conf_num_movies_inp);
  *((&((&llvm_cbe_tmp__943->field19))->field0)) = llvm_cbe_tmp__966;
  llvm_cbe_tmp__967 = *(&rst_inp);
  *((&((&llvm_cbe_tmp__943->field1))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__967&1u))&1))));
  llvm_cbe_tmp__968 = *((&GM.field3));
  *(&llvm_cbe_tmp__920) = (((unsigned char )(bool )(llvm_cbe_tmp__968 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field36)), (&llvm_cbe_tmp__920));
  llvm_cbe_tmp__969 = *((&GM.field2));
  *(&llvm_cbe_tmp__921) = (((unsigned char )(bool )(llvm_cbe_tmp__969 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field12)), (&llvm_cbe_tmp__921));
  llvm_cbe_tmp__970 = *((&GM.field4));
  *(&llvm_cbe_tmp__922) = (((unsigned short )llvm_cbe_tmp__970));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field30)), (&llvm_cbe_tmp__922));
  llvm_cbe_tmp__971 = *((&GM.field9));
  *(&llvm_cbe_tmp__923) = (((unsigned short )llvm_cbe_tmp__971));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field31)), (&llvm_cbe_tmp__923));
  llvm_cbe_tmp__972 = *((&GM.field8));
  *(&llvm_cbe_tmp__924) = (((unsigned short )llvm_cbe_tmp__972));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field32)), (&llvm_cbe_tmp__924));
  llvm_cbe_tmp__973 = *((&GM.field5));
  *(&llvm_cbe_tmp__925) = (((unsigned short )llvm_cbe_tmp__973));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field33)), (&llvm_cbe_tmp__925));
  llvm_cbe_tmp__974 = *((&GM.field7));
  *(&llvm_cbe_tmp__926) = (((unsigned short )llvm_cbe_tmp__974));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field34)), (&llvm_cbe_tmp__926));
  llvm_cbe_tmp__975 = *((&GM.field6));
  *(&llvm_cbe_tmp__927) = (((unsigned short )llvm_cbe_tmp__975));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__943->field35)), (&llvm_cbe_tmp__927));
  llvm_cbe_tmp__976 = *((&GM.field13));
  *(&llvm_cbe_tmp__928) = (((unsigned int )llvm_cbe_tmp__976));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field2)), (&llvm_cbe_tmp__928));
  llvm_cbe_tmp__977 = *((&GM.field14));
  *(&llvm_cbe_tmp__929) = (((unsigned int )llvm_cbe_tmp__977));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field3)), (&llvm_cbe_tmp__929));
  llvm_cbe_tmp__978 = *((&GM.field15));
  *(&llvm_cbe_tmp__930) = (((unsigned char )(bool )(llvm_cbe_tmp__978 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__930));
  llvm_cbe_tmp__979 = *(&rd_grant_inp);
  *((&((&llvm_cbe_tmp__943->field5))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__979&1u))&1))));
  llvm_cbe_tmp__980 = *(&data_in_inp);
  *((&((&llvm_cbe_tmp__943->field6))->field0)) = llvm_cbe_tmp__980;
  llvm_cbe_tmp__981 = *(&wr_grant_inp);
  *((&((&llvm_cbe_tmp__943->field10))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__981&1u))&1))));
  llvm_cbe_tmp__982 = *((&GM.field20));
  *(&llvm_cbe_tmp__931) = (((unsigned char )(bool )(llvm_cbe_tmp__982 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field9)), (&llvm_cbe_tmp__931));
  llvm_cbe_tmp__983 = *((&GM.field18));
  *(&llvm_cbe_tmp__932) = (((unsigned int )llvm_cbe_tmp__983));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field7)), (&llvm_cbe_tmp__932));
  llvm_cbe_tmp__984 = *((&GM.field19));
  *(&llvm_cbe_tmp__933) = (((unsigned int )llvm_cbe_tmp__984));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field8)), (&llvm_cbe_tmp__933));
  llvm_cbe_tmp__985 = *((&GM.field1));
  *(&llvm_cbe_tmp__934) = (((unsigned int )llvm_cbe_tmp__985));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field11)), (&llvm_cbe_tmp__934));
  llvm_cbe_tmp__986 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), 0u);
  llvm_cbe_tmp__987 = *((&GM.field0.field0));
  __CPROVER_array_copy(llvm_cbe_tmp__986, llvm_cbe_tmp__987);
  llvm_cbe_tmp__988 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__943->field28)), 0u);
  llvm_cbe_tmp__989 = *((&GM.field10.field0));
  __CPROVER_array_copy(llvm_cbe_tmp__988, llvm_cbe_tmp__989);
  llvm_cbe_tmp__990 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field5))))&1);
  if ((((llvm_cbe_tmp__990 ^ 1)&1))) {
    goto llvm_cbe_tmp__1100;
  } else {
    goto llvm_cbe_tmp__1101;
  }
...
llvm_cbe_tmp__1101:
  *(&llvm_cbe_tmp__935) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__935));
  llvm_cbe_tmp__991 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__992 = *(&llvm_cbe_nu);
  *(&llvm_cbe_tmp1) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__991))) * ((unsigned int )llvm_cbe_tmp__992))))));
  llvm_cbe_tmp__993 = *(&llvm_cbe_tmp1);
  llvm_cbe_tmp__994 = *(&llvm_cbe_index);
  *(&llvm_cbe_tmp2) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__993))) + ((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__994))))))));
  llvm_cbe_tmp__995 = *(&llvm_cbe_tmp2);
  *(&llvm_cbe_pingpong) = (((unsigned char )(bool )((((signed int )(((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__995))) % ((signed int )2u)))) != 0u)));
  *(&llvm_cbe_i) = ((unsigned short )0);
  llvm_cbe_tmp__996 = *(&llvm_cbe_i);
  if ((((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__996))) < ((signed int )500u))) {
    goto llvm_cbe_tmp__1102;
  } else {
    goto llvm_cbe_tmp__1103;
  }

llvm_cbe_tmp__1102:
  llvm_cbe_tmp__997 = *(&llvm_cbe_i);
  llvm_cbe_tmp__998 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__999 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field6)));
  *(&llvm_cbe_rate) = (((unsigned char )llvm_cbe_tmp__999));
  _Z4waitv();
  *(&llvm_cbe_pingpong) = ((unsigned char )0);
  llvm_cbe_tmp__1000 = *(&llvm_cbe_rate);
  llvm_cbe_tmp__1001 = *(&llvm_cbe_i);
  llvm_cbe_tmp__1002 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__1003 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1002&1u))&1)))));
  *((&llvm_cbe_tmp__1003[((signed long long )(((unsigned long long )(unsigned short )llvm_cbe_tmp__1001)))])) = llvm_cbe_tmp__1000;
  llvm_cbe_tmp__1004 = *(&conf_done_inp);
  llvm_cbe_tmp__1005 = *(&conf_num_hidden_inp);
  llvm_cbe_tmp__1006 = *(&conf_num_visible_inp);
  llvm_cbe_tmp__1007 = *(&conf_num_users_inp);
  llvm_cbe_tmp__1008 = *(&conf_num_loops_inp);
  llvm_cbe_tmp__1009 = *(&conf_num_testusers_inp);
  llvm_cbe_tmp__1010 = *(&conf_num_movies_inp);
  llvm_cbe_tmp__1011 = *(&rst_inp);
  llvm_cbe_tmp__1012 = *(&rd_grant_inp);
  llvm_cbe_tmp__1013 = *(&data_in_inp);
  llvm_cbe_tmp__1014 = *(&wr_grant_inp);
  _ZN9model_RBM6updateElllllllllll((&GM), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__1004&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1005)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1006)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1007)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1008)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1009)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1010)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__1011&1u))&1)))), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__1012&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__1013)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__1014&1u))&1)))));
  llvm_cbe_tmp__1015 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field36))))&1);
  llvm_cbe_tmp__1016 = *((&GM.field3));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__1015)) == llvm_cbe_tmp__1016), ((&_OC_str1.array[((signed int )0u)])));
  llvm_cbe_tmp__1017 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field12))))&1);
  llvm_cbe_tmp__1018 = *((&GM.field2));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__1017)) == llvm_cbe_tmp__1018), ((&_OC_str2.array[((signed int )0u)])));
  llvm_cbe_tmp__1019 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field30)));
  llvm_cbe_tmp__1020 = *((&GM.field4));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1019)) == llvm_cbe_tmp__1020), ((&_OC_str3.array[((signed int )0u)])));
  llvm_cbe_tmp__1021 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field31)));
  llvm_cbe_tmp__1022 = *((&GM.field9));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1021)) == llvm_cbe_tmp__1022), ((&_OC_str4.array[((signed int )0u)])));
  llvm_cbe_tmp__1023 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field32)));
  llvm_cbe_tmp__1024 = *((&GM.field8));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1023)) == llvm_cbe_tmp__1024), ((&_OC_str5.array[((signed int )0u)])));
  llvm_cbe_tmp__1025 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field33)));
  llvm_cbe_tmp__1026 = *((&GM.field5));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1025)) == llvm_cbe_tmp__1026), ((&_OC_str6.array[((signed int )0u)])));
  llvm_cbe_tmp__1027 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field34)));
  llvm_cbe_tmp__1028 = *((&GM.field7));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1027)) == llvm_cbe_tmp__1028), ((&_OC_str7.array[((signed int )0u)])));
  llvm_cbe_tmp__1029 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__943->field35)));
  llvm_cbe_tmp__1030 = *((&GM.field6));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__1029)) == llvm_cbe_tmp__1030), ((&_OC_str8.array[((signed int )0u)])));
  llvm_cbe_tmp__1031 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field2)));
  llvm_cbe_tmp__1032 = *((&GM.field13));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__1031)) == llvm_cbe_tmp__1032), ((&_OC_str9.array[((signed int )0u)])));
  llvm_cbe_tmp__1033 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field3)));
  llvm_cbe_tmp__1034 = *((&GM.field14));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__1033)) == llvm_cbe_tmp__1034), ((&_OC_str10.array[((signed int )0u)])));
  llvm_cbe_tmp__1035 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field9))))&1);
  llvm_cbe_tmp__1036 = *((&GM.field20));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__1035)) == llvm_cbe_tmp__1036), ((&_OC_str11.array[((signed int )0u)])));
  llvm_cbe_tmp__1037 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field7)));
  llvm_cbe_tmp__1038 = *((&GM.field18));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__1037)) == llvm_cbe_tmp__1038), ((&_OC_str12.array[((signed int )0u)])));
  llvm_cbe_tmp__1039 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field8)));
  llvm_cbe_tmp__1040 = *((&GM.field19));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__1039)) == llvm_cbe_tmp__1040), ((&_OC_str13.array[((signed int )0u)])));
  llvm_cbe_tmp__1041 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field11)));
  llvm_cbe_tmp__1042 = *((&GM.field1));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__1041)) == llvm_cbe_tmp__1042), ((&_OC_str14.array[((signed int )0u)])));
  llvm_cbe_tmp__1043 = *((&GM.field0.field0));
  llvm_cbe_tmp__1044 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), 0u);
  llvm_cbe_tmp__1045 = ((__CPROVER_array_equal(llvm_cbe_tmp__1043, llvm_cbe_tmp__1044))&1);
  __CPROVER_assert(llvm_cbe_tmp__1045, ((&_OC_str15.array[((signed int )0u)])));
  llvm_cbe_tmp__1046 = *((&GM.field10.field0));
  llvm_cbe_tmp__1047 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__943->field28)), 0u);
  llvm_cbe_tmp__1048 = ((__CPROVER_array_equal(llvm_cbe_tmp__1046, llvm_cbe_tmp__1047))&1);
  __CPROVER_assert(llvm_cbe_tmp__1048, ((&_OC_str16.array[((signed int )0u)])));
  __CPROVER_assert(0, ((&_OC_str17.array[((signed int )0u)])));
  return;
llvm_cbe_tmp__1103:
  _Z4waitv();
  llvm_cbe_tmp__1049 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__1050 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__1051 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1050&1u))&1)))));
  *((&llvm_cbe_tmp__1051[((signed long long )(((unsigned long long )(unsigned int )llvm_cbe_tmp__1049)))])) = ((unsigned char )1);
  goto llvm_cbe_tmp__1104;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1104:
  llvm_cbe_tmp__1052 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1053 = *(&llvm_cbe_nlp);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1052)) != llvm_cbe_tmp__1053)) {
...
llvm_cbe_tmp__1107:
  _Z4waitv();
  llvm_cbe_tmp__1094 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__1095 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__1096 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1095&1u))&1)))));
  *((&llvm_cbe_tmp__1096[((signed long long )(((unsigned long long )(unsigned int )llvm_cbe_tmp__1094)))])) = ((unsigned char )1);
  goto llvm_cbe_tmp__1104;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1108:
  llvm_cbe_tmp__1085 = *(&llvm_cbe_i1);
  if ((((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1085))) < ((signed int )500u))) {
...
llvm_cbe_tmp__1110:
  llvm_cbe_tmp__1088 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__943->field6)));
  *(&llvm_cbe_rate2) = (((unsigned char )llvm_cbe_tmp__1088));
  _Z4waitv();
  llvm_cbe_tmp__1089 = *(&llvm_cbe_rate2);
  llvm_cbe_tmp__1090 = *(&llvm_cbe_i1);
  llvm_cbe_tmp__1091 = *(&llvm_cbe_pingpong);
  llvm_cbe_tmp__1092 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__943->field20)), (((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1091&1u))&1)))));
  *((&llvm_cbe_tmp__1092[((signed long long )(((unsigned long long )(unsigned short )llvm_cbe_tmp__1090)))])) = llvm_cbe_tmp__1089;
  llvm_cbe_tmp__1093 = *(&llvm_cbe_i1);
  *(&llvm_cbe_i1) = (((unsigned short )(((unsigned short )(((unsigned short )llvm_cbe_tmp__1093) + ((unsigned short )((unsigned short )1)))))));
  goto llvm_cbe_tmp__1108;

llvm_cbe_tmp__1109:
  llvm_cbe_tmp__1086 = *(&llvm_cbe_i1);
  llvm_cbe_tmp__1087 = *(&llvm_cbe_nv);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1086)) == llvm_cbe_tmp__1087)) {
    goto llvm_cbe_tmp__1107;
  } else {
...
llvm_cbe_tmp__1111:
  *(&llvm_cbe_tmp__942) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__942));
  llvm_cbe_tmp__1080 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1081 = *(&llvm_cbe_nu);
  *(&llvm_cbe_tmp1) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1080))) * ((unsigned int )llvm_cbe_tmp__1081))))));
  llvm_cbe_tmp__1082 = *(&llvm_cbe_tmp1);
  llvm_cbe_tmp__1083 = *(&llvm_cbe_index);
  *(&llvm_cbe_tmp2) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1082))) + ((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1083))))))));
  llvm_cbe_tmp__1084 = *(&llvm_cbe_tmp2);
  *(&llvm_cbe_pingpong) = (((unsigned char )(bool )((((signed int )(((signed int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1084))) % ((signed int )2u)))) != 0u)));
...
llvm_cbe_tmp__1112:
  _Z4waitv();
  llvm_cbe_tmp__1079 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field5))))&1);
  if ((((llvm_cbe_tmp__1079 ^ 1)&1))) {
...
llvm_cbe_tmp__1113:
  *(&llvm_cbe_tmp__941) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field4)), (&llvm_cbe_tmp__941));
  goto llvm_cbe_tmp__1112;

llvm_cbe_tmp__1114:
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field2)), (&llvm_cbe_dma_index));
  llvm_cbe_tmp__1075 = *(&llvm_cbe_nm);
  *(&llvm_cbe_tmp__940) = (((unsigned int )(((unsigned int )5u) * ((unsigned int )llvm_cbe_tmp__1075))));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__943->field3)), (&llvm_cbe_tmp__940));
  llvm_cbe_tmp__1076 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1077 = *(&llvm_cbe_nlp);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1076)) == llvm_cbe_tmp__1077)) {
...
llvm_cbe_tmp__1116:
  llvm_cbe_tmp__1068 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__1069 = *(&llvm_cbe_index);
  *(&llvm_cbe_dma_index) = (((unsigned int )(((unsigned int )llvm_cbe_tmp__1068) * ((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1069))))));
  llvm_cbe_tmp__1070 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1071 = *(&llvm_cbe_nlp);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1070)) == llvm_cbe_tmp__1071)) {
...
llvm_cbe_tmp__1118:
  llvm_cbe_tmp__1064 = *(&llvm_cbe_index);
  llvm_cbe_tmp__1065 = *(&llvm_cbe_ntu);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1064)) == llvm_cbe_tmp__1065)) {
...
llvm_cbe_tmp__1120:
  llvm_cbe_tmp__1058 = *(&llvm_cbe_index);
  *(&llvm_cbe_index) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1058))) + ((unsigned int )1u))))));
  llvm_cbe_tmp__1059 = *(&llvm_cbe_index);
  llvm_cbe_tmp__1060 = *(&llvm_cbe_nu);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1059)) == llvm_cbe_tmp__1060)) {
...
llvm_cbe_tmp__1122:
  _Z4waitv();
  llvm_cbe_tmp__1055 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field39))))&1);
  if (llvm_cbe_tmp__1055) {
...
llvm_cbe_tmp__1123:
  *(&llvm_cbe_tmp__937) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field37)), (&llvm_cbe_tmp__937));
  goto llvm_cbe_tmp__1122;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1124:
  _Z4waitv();
  llvm_cbe_tmp__1054 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field39))))&1);
  if ((((llvm_cbe_tmp__1054 ^ 1)&1))) {
...
llvm_cbe_tmp__1105:
  *(&llvm_cbe_tmp__936) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field37)), (&llvm_cbe_tmp__936));
  goto llvm_cbe_tmp__1124;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1125:
  _Z4waitv();
  llvm_cbe_tmp__1057 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field42))))&1);
  if (llvm_cbe_tmp__1057) {
...
llvm_cbe_tmp__1126:
  *(&llvm_cbe_tmp__939) = ((unsigned char )0);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field38)), (&llvm_cbe_tmp__939));
  goto llvm_cbe_tmp__1125;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1127:
  _Z4waitv();
  llvm_cbe_tmp__1056 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field42))))&1);
  if ((((llvm_cbe_tmp__1056 ^ 1)&1))) {
...
llvm_cbe_tmp__1106:
  *(&llvm_cbe_tmp__938) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__943->field38)), (&llvm_cbe_tmp__938));
  goto llvm_cbe_tmp__1127;

llvm_cbe_tmp__1121:
  llvm_cbe_tmp__1061 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1062 = *(&llvm_cbe_nlp);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1061)) != llvm_cbe_tmp__1062)) {
...
llvm_cbe_tmp__1128:
  llvm_cbe_tmp__1063 = *(&llvm_cbe_loop_count);
  *(&llvm_cbe_loop_count) = (((unsigned short )(((unsigned int )(((unsigned int )(((unsigned int )(unsigned short )llvm_cbe_tmp__1063))) + ((unsigned int )1u))))));
  *(&llvm_cbe_index) = ((unsigned short )0);
  goto llvm_cbe_tmp__1118;

llvm_cbe_tmp__1119:
  llvm_cbe_tmp__1066 = *(&llvm_cbe_loop_count);
  llvm_cbe_tmp__1067 = *(&llvm_cbe_nlp);
  if (((((unsigned int )(unsigned short )llvm_cbe_tmp__1066)) == llvm_cbe_tmp__1067)) {
...
llvm_cbe_tmp__1117:
  llvm_cbe_tmp__1072 = *(&llvm_cbe_nv);
  llvm_cbe_tmp__1073 = *(&llvm_cbe_nu);
  llvm_cbe_tmp__1074 = *(&llvm_cbe_dma_index);
  *(&llvm_cbe_dma_index) = (((unsigned int )(((unsigned int )llvm_cbe_tmp__1074) + ((unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__1072) * ((unsigned int )llvm_cbe_tmp__1073))))))));
  goto llvm_cbe_tmp__1114;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__1115:
  _Z4waitv();
  llvm_cbe_tmp__1078 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__943->field40))))&1);
  if ((((llvm_cbe_tmp__1078 ^ 1)&1))) {
    goto llvm_cbe_tmp__1115;
  } else {
    goto llvm_cbe_tmp__1113;
  }
...
bool _ZN14sc_signal_boolaSERKb(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_d) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1130;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1131;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1132;
  unsigned char *llvm_cbe_tmp__1133;
  unsigned char llvm_cbe_tmp__1134;
  unsigned char llvm_cbe_tmp__1135;

  *(&llvm_cbe_tmp__1130) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1131) = llvm_cbe_d;
  llvm_cbe_tmp__1132 = *(&llvm_cbe_tmp__1130);
  llvm_cbe_tmp__1133 = *(&llvm_cbe_tmp__1131);
  llvm_cbe_tmp__1134 = *llvm_cbe_tmp__1133;
  *((&llvm_cbe_tmp__1132->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__1134&1u))&1))));
  llvm_cbe_tmp__1135 = *((&llvm_cbe_tmp__1132->field0));
  return (((((bool )llvm_cbe_tmp__1135&1u))&1));
}


void _ZN13sc_signal_u325writeERKj(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned int *llvm_cbe_d) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1136;    /* Address-exposed local */
  unsigned int *llvm_cbe_tmp__1137;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1138;
  unsigned int *llvm_cbe_tmp__1139;
  unsigned int llvm_cbe_tmp__1140;

  *(&llvm_cbe_tmp__1136) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1137) = llvm_cbe_d;
  llvm_cbe_tmp__1138 = *(&llvm_cbe_tmp__1136);
  llvm_cbe_tmp__1139 = *(&llvm_cbe_tmp__1137);
  llvm_cbe_tmp__1140 = *llvm_cbe_tmp__1139;
  *((&llvm_cbe_tmp__1138->field0)) = llvm_cbe_tmp__1140;
  return;
}


unsigned short _ZN13sc_signal_u164readEv(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1141;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1142;
  unsigned short llvm_cbe_tmp__1143;

  *(&llvm_cbe_tmp__1141) = llvm_cbe_this;
...
unsigned char *_ZN11SysCArray2DIhLj2ELj512EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  unsigned char *llvm_cbe_tmp__1144;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1145;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1146;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1147;
  ...
  *(&llvm_cbe_tmp__1145) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1146) = llvm_cbe_Xidx;
  llvm_cbe_tmp__1147 = *(&llvm_cbe_tmp__1145);
  llvm_cbe_tmp__1148 = *(&llvm_cbe_tmp__1146);
  if ((llvm_cbe_tmp__1148 == 0u)) {
...
llvm_cbe_tmp__1153:
  llvm_cbe_tmp__1149 = *((&llvm_cbe_tmp__1147->field1));
  *(&llvm_cbe_tmp__1144) = llvm_cbe_tmp__1149;
  goto llvm_cbe_tmp__1155;

llvm_cbe_tmp__1154:
  llvm_cbe_tmp__1150 = *(&llvm_cbe_tmp__1146);
  llvm_cbe_tmp__1151 = *((&llvm_cbe_tmp__1147->field0));
  *(&llvm_cbe_tmp__1144) = ((&llvm_cbe_tmp__1151[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__1150) * ((unsigned int )512u)))))))]));
  goto llvm_cbe_tmp__1155;

llvm_cbe_tmp__1155:
  llvm_cbe_tmp__1152 = *(&llvm_cbe_tmp__1144);
  return llvm_cbe_tmp__1152;
}


unsigned char *_ZN11SysCArray2DIhLj2ELj128EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  unsigned char *llvm_cbe_tmp__1156;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1157;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1158;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1159;
  unsigned int llvm_cbe_tmp__1160;
  unsigned char *llvm_cbe_tmp__1161;
  unsigned int llvm_cbe_tmp__1162;
  unsigned char *llvm_cbe_tmp__1163;
  unsigned char *llvm_cbe_tmp__1164;

  *(&llvm_cbe_tmp__1157) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1158) = llvm_cbe_Xidx;
  llvm_cbe_tmp__1159 = *(&llvm_cbe_tmp__1157);
  llvm_cbe_tmp__1160 = *(&llvm_cbe_tmp__1158);
  if ((llvm_cbe_tmp__1160 == 0u)) {
...
llvm_cbe_tmp__1166:
  llvm_cbe_tmp__1162 = *(&llvm_cbe_tmp__1158);
  llvm_cbe_tmp__1163 = *((&llvm_cbe_tmp__1159->field0));
  *(&llvm_cbe_tmp__1156) = ((&llvm_cbe_tmp__1163[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__1162) * ((unsigned int )128u)))))))]));
  goto llvm_cbe_tmp__1167;

llvm_cbe_tmp__1167:
  llvm_cbe_tmp__1164 = *(&llvm_cbe_tmp__1156);
  return llvm_cbe_tmp__1164;
}
...
void _ZN3rbmC1Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__1168;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__1169;

  *(&llvm_cbe_tmp__1168) = llvm_cbe_this;
  llvm_cbe_tmp__1169 = *(&llvm_cbe_tmp__1168);
  _ZN3rbmC2Ev(llvm_cbe_tmp__1169);
  return;
}


unsigned int main(void) {
  unsigned int llvm_cbe_tmp__1170;    /* Address-exposed local */
  _GLOBAL__I_a();  CODE_FOR_MAIN();
  *(&llvm_cbe_tmp__1170) = 0u;
  _ZN3rbm4loadEv((&IMPL));
  return 0u;
}
...
void _ZN8type_memIhLj512EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1171;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1172;
  unsigned char *llvm_cbe_tmp__1173;

  *(&llvm_cbe_tmp__1171) = llvm_cbe_this;
  llvm_cbe_tmp__1172 = *(&llvm_cbe_tmp__1171);
  llvm_cbe_tmp__1173 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1172->field0)) = llvm_cbe_tmp__1173;
  return;
}


void _ZN8type_memIhLj512EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1174;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1175;

  *(&llvm_cbe_tmp__1174) = llvm_cbe_this;
  llvm_cbe_tmp__1175 = *(&llvm_cbe_tmp__1174);
  return;
}


void _ZN3rbmC2Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__1176;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__1177;
  unsigned char *llvm_cbe_tmp__1178;
  unsigned char llvm_cbe_tmp__1179;
  unsigned char *llvm_cbe_tmp__1180;
  ...
  *(&llvm_cbe_tmp__1176) = llvm_cbe_this;
  llvm_cbe_tmp__1177 = *(&llvm_cbe_tmp__1176);
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field0)), ((&_OC_str19.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field1)), ((&_OC_str20.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field2)), ((&_OC_str21.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field3)), ((&_OC_str22.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field4)), ((&_OC_str23.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field5)), ((&_OC_str24.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field6)), ((&_OC_str25.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field7)), ((&_OC_str26.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field8)), ((&_OC_str27.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field9)), ((&_OC_str28.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field10)), ((&_OC_str29.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field11)), ((&_OC_str30.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field12)), ((&_OC_str31.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1177->field13)), ((&_OC_str32.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field14)), ((&_OC_str33.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field15)), ((&_OC_str34.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field16)), ((&_OC_str35.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field17)), ((&_OC_str36.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field18)), ((&_OC_str37.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1177->field19)), ((&_OC_str38.array[((signed int )0u)])));
  _ZN11SysCArray2DIhLj2ELj512EEC1Ev(((&llvm_cbe_tmp__1177->field20)));
  _ZN11SysCArray1DIbLj512EEC1Ev(((&llvm_cbe_tmp__1177->field21)));
  _ZN11SysCArray1DIbLj128EEC1Ev(((&llvm_cbe_tmp__1177->field22)));
  _ZN11SysCArray2DIfLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1177->field23)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1177->field24)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1177->field25)));
  _ZN11SysCArray1DIfLj5EEC1Ev(((&llvm_cbe_tmp__1177->field26)));
  _ZN11SysCArray1DIbLj512EEC1Ev(((&llvm_cbe_tmp__1177->field27)));
  _ZN11SysCArray2DIhLj2ELj128EEC1Ev(((&llvm_cbe_tmp__1177->field28)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field30)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field31)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field32)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field33)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field34)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1177->field35)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field36)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field37)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field38)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field39)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field40)));
  _ZN15sc_signal_int32C1Ev(((&llvm_cbe_tmp__1177->field41)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field42)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field43)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field44)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1177->field45)));
  llvm_cbe_tmp__1178 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1177->field1)));
  llvm_cbe_tmp__1179 = *llvm_cbe_tmp__1178;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1179&1u))&1)))), 0);
  llvm_cbe_tmp__1180 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1177->field1)));
  llvm_cbe_tmp__1181 = *llvm_cbe_tmp__1180;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1181&1u))&1)))), 0);
  llvm_cbe_tmp__1182 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1177->field1)));
  llvm_cbe_tmp__1183 = *llvm_cbe_tmp__1182;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1183&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__1184 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1177->field1)));
  llvm_cbe_tmp__1185 = *llvm_cbe_tmp__1184;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1185&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__1186 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1177->field1)));
  llvm_cbe_tmp__1187 = *llvm_cbe_tmp__1186;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1187&1u))&1)))), 0);
  return;
}


void _ZN14sc_signal_boolC1EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1188;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1189;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1190;
  unsigned char *llvm_cbe_tmp__1191;

  *(&llvm_cbe_tmp__1188) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1189) = llvm_cbe_p;
  llvm_cbe_tmp__1190 = *(&llvm_cbe_tmp__1188);
  llvm_cbe_tmp__1191 = *(&llvm_cbe_tmp__1189);
  _ZN14sc_signal_boolC2EPKc(llvm_cbe_tmp__1190, llvm_cbe_tmp__1191);
  return;
}


void _ZN13sc_signal_u32C1EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1192;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1193;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1194;
  unsigned char *llvm_cbe_tmp__1195;

  *(&llvm_cbe_tmp__1192) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1193) = llvm_cbe_p;
  llvm_cbe_tmp__1194 = *(&llvm_cbe_tmp__1192);
  llvm_cbe_tmp__1195 = *(&llvm_cbe_tmp__1193);
  _ZN13sc_signal_u32C2EPKc(llvm_cbe_tmp__1194, llvm_cbe_tmp__1195);
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1196;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1197;

  *(&llvm_cbe_tmp__1196) = llvm_cbe_this;
  llvm_cbe_tmp__1197 = *(&llvm_cbe_tmp__1196);
  _ZN11SysCArray2DIhLj2ELj512EEC2Ev(llvm_cbe_tmp__1197);
  return;
}


void _ZN11SysCArray1DIbLj512EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1198;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1199;

  *(&llvm_cbe_tmp__1198) = llvm_cbe_this;
  llvm_cbe_tmp__1199 = *(&llvm_cbe_tmp__1198);
  _ZN11SysCArray1DIbLj512EEC2Ev(llvm_cbe_tmp__1199);
  return;
}


void _ZN11SysCArray1DIbLj128EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1200;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1201;

  *(&llvm_cbe_tmp__1200) = llvm_cbe_this;
  llvm_cbe_tmp__1201 = *(&llvm_cbe_tmp__1200);
  _ZN11SysCArray1DIbLj128EEC2Ev(llvm_cbe_tmp__1201);
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC1Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__1202;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__1203;

  *(&llvm_cbe_tmp__1202) = llvm_cbe_this;
  llvm_cbe_tmp__1203 = *(&llvm_cbe_tmp__1202);
  _ZN11SysCArray2DIfLj501ELj101EEC2Ev(llvm_cbe_tmp__1203);
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1204;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1205;

  *(&llvm_cbe_tmp__1204) = llvm_cbe_this;
  llvm_cbe_tmp__1205 = *(&llvm_cbe_tmp__1204);
  _ZN11SysCArray2DIbLj501ELj101EEC2Ev(llvm_cbe_tmp__1205);
  return;
}


void _ZN11SysCArray1DIfLj5EEC1Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__1206;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__1207;

  *(&llvm_cbe_tmp__1206) = llvm_cbe_this;
  llvm_cbe_tmp__1207 = *(&llvm_cbe_tmp__1206);
  _ZN11SysCArray1DIfLj5EEC2Ev(llvm_cbe_tmp__1207);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1208;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1209;

  *(&llvm_cbe_tmp__1208) = llvm_cbe_this;
  llvm_cbe_tmp__1209 = *(&llvm_cbe_tmp__1208);
  _ZN11SysCArray2DIhLj2ELj128EEC2Ev(llvm_cbe_tmp__1209);
  return;
}


void _ZN13sc_signal_u16C1Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1210;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1211;

  *(&llvm_cbe_tmp__1210) = llvm_cbe_this;
  llvm_cbe_tmp__1211 = *(&llvm_cbe_tmp__1210);
  _ZN13sc_signal_u16C2Ev(llvm_cbe_tmp__1211);
  return;
}


void _ZN14sc_signal_boolC1Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1212;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1213;

  *(&llvm_cbe_tmp__1212) = llvm_cbe_this;
  llvm_cbe_tmp__1213 = *(&llvm_cbe_tmp__1212);
  _ZN14sc_signal_boolC2Ev(llvm_cbe_tmp__1213);
  return;
}


void _ZN15sc_signal_int32C1Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1214;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1215;

  *(&llvm_cbe_tmp__1214) = llvm_cbe_this;
  llvm_cbe_tmp__1215 = *(&llvm_cbe_tmp__1214);
  _ZN15sc_signal_int32C2Ev(llvm_cbe_tmp__1215);
  return;
}


unsigned char *_ZN14sc_signal_boolcvRbEv(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1216;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1217;

  *(&llvm_cbe_tmp__1216) = llvm_cbe_this;
  llvm_cbe_tmp__1217 = *(&llvm_cbe_tmp__1216);
  return ((&llvm_cbe_tmp__1217->field0));
}


void _ZN15sc_signal_int32C2Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1218;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1219;

  *(&llvm_cbe_tmp__1218) = llvm_cbe_this;
  llvm_cbe_tmp__1219 = *(&llvm_cbe_tmp__1218);
  return;
}


void _ZN14sc_signal_boolC2Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1220;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1221;

  *(&llvm_cbe_tmp__1220) = llvm_cbe_this;
  llvm_cbe_tmp__1221 = *(&llvm_cbe_tmp__1220);
  return;
}


void _ZN13sc_signal_u16C2Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1222;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1223;

  *(&llvm_cbe_tmp__1222) = llvm_cbe_this;
  llvm_cbe_tmp__1223 = *(&llvm_cbe_tmp__1222);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1224;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1225;
  unsigned char *llvm_cbe_tmp__1226;
  unsigned char *llvm_cbe_tmp__1227;

  *(&llvm_cbe_tmp__1224) = llvm_cbe_this;
  llvm_cbe_tmp__1225 = *(&llvm_cbe_tmp__1224);
  llvm_cbe_tmp__1226 = __CPROVER_malloc(256ull);
  *((&llvm_cbe_tmp__1225->field0)) = llvm_cbe_tmp__1226;
  llvm_cbe_tmp__1227 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__1225->field1)) = llvm_cbe_tmp__1227;
  return;
}


void _ZN11SysCArray1DIfLj5EEC2Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__1228;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__1229;
  unsigned char *llvm_cbe_tmp__1230;

  *(&llvm_cbe_tmp__1228) = llvm_cbe_this;
  llvm_cbe_tmp__1229 = *(&llvm_cbe_tmp__1228);
  llvm_cbe_tmp__1230 = __CPROVER_malloc(20ull);
  *((&llvm_cbe_tmp__1229->field0)) = (((float *)llvm_cbe_tmp__1230));
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1231;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1232;
  unsigned char *llvm_cbe_tmp__1233;
  unsigned char *llvm_cbe_tmp__1234;

  *(&llvm_cbe_tmp__1231) = llvm_cbe_this;
  llvm_cbe_tmp__1232 = *(&llvm_cbe_tmp__1231);
  llvm_cbe_tmp__1233 = __CPROVER_malloc(50601ull);
  *((&llvm_cbe_tmp__1232->field0)) = llvm_cbe_tmp__1233;
  llvm_cbe_tmp__1234 = __CPROVER_malloc(101ull);
  *((&llvm_cbe_tmp__1232->field1)) = llvm_cbe_tmp__1234;
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC2Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__1235;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__1236;
  ...
  *(&llvm_cbe_tmp__1235) = llvm_cbe_this;
  ...
  llvm_cbe_tmp__1237 = __CPROVER_malloc(202404ull);
  *((&llvm_cbe_tmp__1236->field0)) = (((float *)llvm_cbe_tmp__1237));
  llvm_cbe_tmp__1238 = __CPROVER_malloc(404ull);
  *((&llvm_cbe_tmp__1236->field1)) = (((float *)llvm_cbe_tmp__1238));
  return;
}


void _ZN11SysCArray1DIbLj128EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1239;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1240;
  unsigned char *llvm_cbe_tmp__1241;

  *(&llvm_cbe_tmp__1239) = llvm_cbe_this;
  llvm_cbe_tmp__1240 = *(&llvm_cbe_tmp__1239);
  llvm_cbe_tmp__1241 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__1240->field0)) = llvm_cbe_tmp__1241;
  return;
}


void _ZN11SysCArray1DIbLj512EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1242;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1243;
  unsigned char *llvm_cbe_tmp__1244;

  *(&llvm_cbe_tmp__1242) = llvm_cbe_this;
  llvm_cbe_tmp__1243 = *(&llvm_cbe_tmp__1242);
  llvm_cbe_tmp__1244 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1243->field0)) = llvm_cbe_tmp__1244;
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1245;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1246;
  unsigned char *llvm_cbe_tmp__1247;
  unsigned char *llvm_cbe_tmp__1248;

  *(&llvm_cbe_tmp__1245) = llvm_cbe_this;
  llvm_cbe_tmp__1246 = *(&llvm_cbe_tmp__1245);
  llvm_cbe_tmp__1247 = __CPROVER_malloc(1024ull);
  *((&llvm_cbe_tmp__1246->field0)) = llvm_cbe_tmp__1247;
  llvm_cbe_tmp__1248 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1246->field1)) = llvm_cbe_tmp__1248;
  return;
}


void _ZN13sc_signal_u32C2EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1249;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1250;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1251;

  *(&llvm_cbe_tmp__1249) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1250) = llvm_cbe_p;
  llvm_cbe_tmp__1251 = *(&llvm_cbe_tmp__1249);
  return;
}


void _ZN14sc_signal_boolC2EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1252;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1253;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1254;

  *(&llvm_cbe_tmp__1252) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1253) = llvm_cbe_p;
...
void _ZN9model_RBMD2Ev(struct l_class_OC_model_RBM *llvm_cbe_this) {
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1255;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1256;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1257;    /* Address-exposed local */
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1258;

  *(&llvm_cbe_tmp__1255) = llvm_cbe_this;
  llvm_cbe_tmp__1258 = *(&llvm_cbe_tmp__1255);
  _ZN8type_memIhLj128EED1Ev(((&llvm_cbe_tmp__1258->field10)));
  _ZN8type_memIhLj512EED1Ev(((&llvm_cbe_tmp__1258->field0)));
  return;
}
...
void _ZN8type_memIhLj128EED1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  ...
  *(&llvm_cbe_tmp__1259) = llvm_cbe_this;
  ...
  _ZN8type_memIhLj128EED2Ev(llvm_cbe_tmp__1260);
  return;
}


void _ZN8type_memIhLj128EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1261;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1262;
...
void _ZN9model_RBMC2Ev(struct l_class_OC_model_RBM *llvm_cbe_this) {
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1263;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1264;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1265;    /* Address-exposed local */
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1266;

  *(&llvm_cbe_tmp__1263) = llvm_cbe_this;
  llvm_cbe_tmp__1266 = *(&llvm_cbe_tmp__1263);
  _ZN8type_memIhLj512EEC1El(((&llvm_cbe_tmp__1266->field0)), 0ull);
  _ZN8type_memIhLj128EEC1El(((&llvm_cbe_tmp__1266->field10)), 0ull);
  *((&llvm_cbe_tmp__1266->field21)) = 65535ull;
  *((&llvm_cbe_tmp__1266->field22)) = 255ull;
  return;
}


void _ZN8type_memIhLj512EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1267;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1268;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1269;
  unsigned long long llvm_cbe_tmp__1270;

  *(&llvm_cbe_tmp__1267) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1268) = llvm_cbe_def;
  llvm_cbe_tmp__1269 = *(&llvm_cbe_tmp__1267);
  llvm_cbe_tmp__1270 = *(&llvm_cbe_tmp__1268);
  _ZN8type_memIhLj512EEC2El(llvm_cbe_tmp__1269, llvm_cbe_tmp__1270);
  return;
}


void _ZN8type_memIhLj128EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1271;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1272;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1273;
  unsigned long long llvm_cbe_tmp__1274;

  *(&llvm_cbe_tmp__1271) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1272) = llvm_cbe_def;
  llvm_cbe_tmp__1273 = *(&llvm_cbe_tmp__1271);
  llvm_cbe_tmp__1274 = *(&llvm_cbe_tmp__1272);
  _ZN8type_memIhLj128EEC2El(llvm_cbe_tmp__1273, llvm_cbe_tmp__1274);
  return;
}


void _ZN8type_memIhLj128EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1275;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1276;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1277;
  unsigned char *llvm_cbe_tmp__1278;

  *(&llvm_cbe_tmp__1275) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1276) = llvm_cbe_def;
  llvm_cbe_tmp__1277 = *(&llvm_cbe_tmp__1275);
  llvm_cbe_tmp__1278 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__1277->field0)) = llvm_cbe_tmp__1278;
  return;
}


void _ZN8type_memIhLj512EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1279;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1280;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1281;
  unsigned char *llvm_cbe_tmp__1282;

  *(&llvm_cbe_tmp__1279) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1280) = llvm_cbe_def;
  llvm_cbe_tmp__1281 = *(&llvm_cbe_tmp__1279);
  llvm_cbe_tmp__1282 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1281->field0)) = llvm_cbe_tmp__1282;
  return;
}

...
protected:
  // helper function
  static std::string to_smt2_const(const std::shared_ptr<verilog_expr::VExprAstConstant> & in, SmtType expected_type);
  static std::string to_smt2_var(const std::shared_ptr<verilog_expr::VExprAstVar> & in, SmtType expected_type);

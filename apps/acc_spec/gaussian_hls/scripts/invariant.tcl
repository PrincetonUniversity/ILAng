...
{ ( \
    hls_LB1D_buff == hls_U.hls_target_linebuffer_1_U0.hls_target_linebuffer_Loop_1_proc_U0.in_axi_stream_V_value_V_0_data_out & \
...
{ ( \
    (ila_LB2D_shift_y == 0 & ila_LB2D_shift_x < 8) |-> ( \
        ila_stencil_stream_empty == 1 & \
        ila_gb_p_cnt == 0 & \
        ila_arg_0_TVALID == 0 ) \
)} -type {temporary} -update_db;
...
{ ( \
    (((ila_gb_p_cnt <= ila_LB2D_shift_x - 8) & (ila_LB2D_shift_y == 0)) | (ila_LB2D_shift_y != 0)) & \

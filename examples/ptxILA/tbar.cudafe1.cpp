...
# 64
void dot(int *bar_state_array, int *bar_counter_enter_array, int *bar_counter_exit_array) ;
#if 0
# 64
{ 
# 65
...
# 129
(cudaConfigureCall(blocksPerGrid, threadsPerBlock)) ? (void)0 : (dot)(dev_bar_state_array, dev_bar_counter_enter_array, dev_bar_counter_exit_array); 
# 130
...
# 141
delete [] bar_counter_exit_array; return 0; 
# 180
} 

# 1 "tbar.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__12_tbar_cpp1_ii_703abff6
# 1 "tbar.cudafe1.stub.c"
#include "tbar.cudafe1.stub.c"
# 1 "tbar.cudafe1.stub.c"

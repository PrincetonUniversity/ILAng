...
struct l_struct_OC_rbm {
  ...
  struct l_class_OC_sc_signal_u16 field29;
  ...
  struct l_class_OC_sc_signal_bool field35;
  ...
  struct l_class_OC_sc_signal_int32 field40;
  struct l_class_OC_sc_signal_bool field41;
...
struct l_unnamed10 { unsigned char array[21]; };

struct l_unnamed11 { unsigned char array[4]; };

struct l_unnamed12 { unsigned char array[9]; };
...
struct l_unnamed16 { unsigned char array[19]; };
...
struct l_unnamed17 { struct l_unnamed5 array[1]; };

struct l_unnamed2 { unsigned char array[15]; };

struct l_unnamed6 { unsigned char array[12]; };
...
void _ZN11SysCArray1DIbLj501EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) __ATTRIBUTE_WEAK__;
void _ZN11SysCArray1DIbLj101EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) __ATTRIBUTE_WEAK__;
...
void _ZN11SysCArray1DIbLj101EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) __ATTRIBUTE_WEAK__;
void _ZN11SysCArray1DIbLj501EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) __ATTRIBUTE_WEAK__;
...
static struct l_unnamed1 _OC_str5;
static struct l_unnamed1 _OC_str6;
static struct l_unnamed9 _OC_str7;
static struct l_unnamed7 _OC_str8;
static struct l_unnamed2 _OC_str9;
static struct l_unnamed1 _OC_str10;
static struct l_unnamed7 _OC_str11;
static struct l_unnamed7 _OC_str12;
static struct l_unnamed2 _OC_str13;
static struct l_unnamed1 _OC_str14;
static struct l_unnamed2 _OC_str15;
static struct l_unnamed0 _OC_str16;
static struct l_unnamed10 _OC_str17;
extern struct l_struct_OC_rbm IMPL;
static struct l_unnamed11 _OC_str19;
static struct l_unnamed11 _OC_str20;
static struct l_unnamed12 _OC_str21;
static struct l_unnamed13 _OC_str22;
static struct l_unnamed0 _OC_str23;
static struct l_unnamed12 _OC_str24;
static struct l_unnamed14 _OC_str25;
static struct l_unnamed12 _OC_str26;
static struct l_unnamed13 _OC_str27;
static struct l_unnamed0 _OC_str28;
static struct l_unnamed12 _OC_str29;
static struct l_unnamed12 _OC_str30;
static struct l_unnamed15 _OC_str31;
static struct l_unnamed13 _OC_str32;
static struct l_unnamed1 _OC_str33;
static struct l_unnamed7 _OC_str34;
static struct l_unnamed2 _OC_str35;
static struct l_unnamed2 _OC_str36;
static struct l_unnamed16 _OC_str37;
...
static struct l_unnamed6 _OC_str = { "Config done" };
static struct l_unnamed1 _OC_str1 = { "init_done_match" };
...
static struct l_unnamed1 _OC_str5 = { "num_users_match" };
static struct l_unnamed1 _OC_str6 = { "num_loops_match" };
...
static struct l_unnamed1 _OC_str10 = { "rd_length_match" };
static struct l_unnamed7 _OC_str11 = { "rd_request_match" };
static struct l_unnamed7 _OC_str12 = { "wr_request_match" };
static struct l_unnamed2 _OC_str13 = { "wr_index_match" };
static struct l_unnamed1 _OC_str14 = { "wr_length_match" };
static struct l_unnamed2 _OC_str15 = { "data_out_match" };
static struct l_unnamed0 _OC_str16 = { "data_match" };
static struct l_unnamed10 _OC_str17 = { "predict_result_match" };
struct l_struct_OC_rbm IMPL;
static struct l_unnamed11 _OC_str19 = { "clk" };
static struct l_unnamed11 _OC_str20 = { "rst" };
static struct l_unnamed12 _OC_str21 = { "rd_index" };
static struct l_unnamed13 _OC_str22 = { "rd_length" };
static struct l_unnamed0 _OC_str23 = { "rd_request" };
static struct l_unnamed12 _OC_str24 = { "rd_grant" };
static struct l_unnamed14 _OC_str25 = { "data_in" };
static struct l_unnamed12 _OC_str26 = { "wr_index" };
static struct l_unnamed13 _OC_str27 = { "wr_length" };
static struct l_unnamed0 _OC_str28 = { "wr_request" };
static struct l_unnamed12 _OC_str29 = { "wr_grant" };
static struct l_unnamed12 _OC_str30 = { "data_out" };
static struct l_unnamed15 _OC_str31 = { "done" };
static struct l_unnamed13 _OC_str32 = { "cond_done" };
static struct l_unnamed1 _OC_str33 = { "conf_num_hidden" };
static struct l_unnamed7 _OC_str34 = { "conf_num_visible" };
static struct l_unnamed2 _OC_str35 = { "conf_num_users" };
static struct l_unnamed2 _OC_str36 = { "conf_num_loops" };
static struct l_unnamed16 _OC_str37 = { "conf_num_testusers" };
static struct l_unnamed1 _OC_str38 = { "conf_num_movies" };
...
void _ZN3rbm6configEv(struct l_struct_OC_rbm *llvm_cbe_this) {
  ...
  unsigned char llvm_cbe_tmp__855;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__856;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__857;    /* Address-exposed local */
  ...
  unsigned short llvm_cbe_tmp__861;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__862;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__863;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__864;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__865;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__866;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__867;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__868;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__869;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__870;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__871;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__872;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__873;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__874;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__875;    /* Address-exposed local */
  unsigned short llvm_cbe_tmp__876;    /* Address-exposed local */
  unsigned char llvm_cbe_tmp__877;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__878;
  ...
  unsigned long long llvm_cbe_tmp__894;
  ...
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__917;
  unsigned int llvm_cbe_tmp__918;
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__919;
  ...
  unsigned short llvm_cbe_tmp__943;
  ...
  unsigned long long llvm_cbe_tmp__958;
  unsigned int llvm_cbe_tmp__959;
  unsigned long long llvm_cbe_tmp__960;
  unsigned char *llvm_cbe_tmp__961;
  unsigned char *llvm_cbe_tmp__962;
  bool llvm_cbe_tmp__963;
  unsigned char *llvm_cbe_tmp__964;
  unsigned char *llvm_cbe_tmp__965;
  bool llvm_cbe_tmp__966;

  *(&llvm_cbe_tmp__848) = llvm_cbe_this;
  llvm_cbe_tmp__878 = *(&llvm_cbe_tmp__848);
  goto llvm_cbe_tmp__967;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__967:
  *(&rst_inp) = ((unsigned char )0);
  *(&llvm_cbe_tmp__855) = ((unsigned char )0);
  llvm_cbe_tmp__879 = ((_ZN14sc_signal_boolaSERKb(((&llvm_cbe_tmp__878->field35)), (&llvm_cbe_tmp__855)))&1);
  *(&conf_done_inp) = ((unsigned char )1);
  llvm_cbe_tmp__880 = *(&conf_done_inp);
  *((&((&llvm_cbe_tmp__878->field13))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__880&1u))&1))));
  llvm_cbe_tmp__881 = *(&conf_num_hidden_inp);
  *((&((&llvm_cbe_tmp__878->field14))->field0)) = llvm_cbe_tmp__881;
  llvm_cbe_tmp__882 = *(&conf_num_visible_inp);
  *((&((&llvm_cbe_tmp__878->field15))->field0)) = llvm_cbe_tmp__882;
  llvm_cbe_tmp__883 = *(&conf_num_users_inp);
  *((&((&llvm_cbe_tmp__878->field16))->field0)) = llvm_cbe_tmp__883;
  llvm_cbe_tmp__884 = *(&conf_num_loops_inp);
  *((&((&llvm_cbe_tmp__878->field17))->field0)) = llvm_cbe_tmp__884;
  llvm_cbe_tmp__885 = *(&conf_num_testusers_inp);
  *((&((&llvm_cbe_tmp__878->field18))->field0)) = llvm_cbe_tmp__885;
  llvm_cbe_tmp__886 = *(&conf_num_movies_inp);
  *((&((&llvm_cbe_tmp__878->field19))->field0)) = llvm_cbe_tmp__886;
  llvm_cbe_tmp__887 = *(&rst_inp);
  *((&((&llvm_cbe_tmp__878->field1))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__887&1u))&1))));
  llvm_cbe_tmp__888 = *((&GM.field3));
  *(&llvm_cbe_tmp__856) = (((unsigned char )(bool )(llvm_cbe_tmp__888 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__878->field35)), (&llvm_cbe_tmp__856));
  llvm_cbe_tmp__889 = *((&GM.field2));
  *(&llvm_cbe_tmp__857) = (((unsigned char )(bool )(llvm_cbe_tmp__889 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__878->field12)), (&llvm_cbe_tmp__857));
  llvm_cbe_tmp__890 = *((&GM.field4));
  *(&llvm_cbe_tmp__858) = (((unsigned short )llvm_cbe_tmp__890));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field29)), (&llvm_cbe_tmp__858));
  llvm_cbe_tmp__891 = *((&GM.field9));
  *(&llvm_cbe_tmp__859) = (((unsigned short )llvm_cbe_tmp__891));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field30)), (&llvm_cbe_tmp__859));
  llvm_cbe_tmp__892 = *((&GM.field8));
  *(&llvm_cbe_tmp__860) = (((unsigned short )llvm_cbe_tmp__892));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field31)), (&llvm_cbe_tmp__860));
  llvm_cbe_tmp__893 = *((&GM.field5));
  *(&llvm_cbe_tmp__861) = (((unsigned short )llvm_cbe_tmp__893));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field32)), (&llvm_cbe_tmp__861));
  llvm_cbe_tmp__894 = *((&GM.field7));
  *(&llvm_cbe_tmp__862) = (((unsigned short )llvm_cbe_tmp__894));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field33)), (&llvm_cbe_tmp__862));
  llvm_cbe_tmp__895 = *((&GM.field6));
  *(&llvm_cbe_tmp__863) = (((unsigned short )llvm_cbe_tmp__895));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field34)), (&llvm_cbe_tmp__863));
  llvm_cbe_tmp__896 = *((&GM.field13));
  *(&llvm_cbe_tmp__864) = (((unsigned int )llvm_cbe_tmp__896));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__878->field2)), (&llvm_cbe_tmp__864));
  llvm_cbe_tmp__897 = *((&GM.field14));
  *(&llvm_cbe_tmp__865) = (((unsigned int )llvm_cbe_tmp__897));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__878->field3)), (&llvm_cbe_tmp__865));
  llvm_cbe_tmp__898 = *((&GM.field15));
  *(&llvm_cbe_tmp__866) = (((unsigned char )(bool )(llvm_cbe_tmp__898 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__878->field4)), (&llvm_cbe_tmp__866));
  llvm_cbe_tmp__899 = *(&rd_grant_inp);
  *((&((&llvm_cbe_tmp__878->field5))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__899&1u))&1))));
  llvm_cbe_tmp__900 = *(&data_in_inp);
  *((&((&llvm_cbe_tmp__878->field6))->field0)) = llvm_cbe_tmp__900;
  llvm_cbe_tmp__901 = *(&wr_grant_inp);
  *((&((&llvm_cbe_tmp__878->field10))->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__901&1u))&1))));
  llvm_cbe_tmp__902 = *((&GM.field20));
  *(&llvm_cbe_tmp__867) = (((unsigned char )(bool )(llvm_cbe_tmp__902 != 0ull)));
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__878->field9)), (&llvm_cbe_tmp__867));
  llvm_cbe_tmp__903 = *((&GM.field18));
  *(&llvm_cbe_tmp__868) = (((unsigned int )llvm_cbe_tmp__903));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__878->field7)), (&llvm_cbe_tmp__868));
  llvm_cbe_tmp__904 = *((&GM.field19));
  *(&llvm_cbe_tmp__869) = (((unsigned int )llvm_cbe_tmp__904));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__878->field8)), (&llvm_cbe_tmp__869));
  llvm_cbe_tmp__905 = *((&GM.field1));
  *(&llvm_cbe_tmp__870) = (((unsigned int )llvm_cbe_tmp__905));
  _ZN13sc_signal_u325writeERKj(((&llvm_cbe_tmp__878->field11)), (&llvm_cbe_tmp__870));
  llvm_cbe_tmp__906 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__878->field20)), 0u);
  llvm_cbe_tmp__907 = *((&GM.field0.field0));
  __CPROVER_array_copy(llvm_cbe_tmp__906, llvm_cbe_tmp__907);
  llvm_cbe_tmp__908 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__878->field28)), 0u);
  llvm_cbe_tmp__909 = *((&GM.field10.field0));
  __CPROVER_array_copy(llvm_cbe_tmp__908, llvm_cbe_tmp__909);
  llvm_cbe_tmp__910 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__878->field13))))&1);
  if ((((llvm_cbe_tmp__910 ^ 1)&1))) {
    goto llvm_cbe_tmp__968;
  } else {
    goto llvm_cbe_tmp__969;
  }
...
llvm_cbe_tmp__969:
  llvm_cbe_tmp__911 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field14)));
  *(&llvm_cbe_tmp__871) = (((unsigned short )llvm_cbe_tmp__911));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field29)), (&llvm_cbe_tmp__871));
  llvm_cbe_tmp__912 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field15)));
  *(&llvm_cbe_tmp__872) = (((unsigned short )llvm_cbe_tmp__912));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field30)), (&llvm_cbe_tmp__872));
  llvm_cbe_tmp__913 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field16)));
  *(&llvm_cbe_tmp__873) = (((unsigned short )llvm_cbe_tmp__913));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field31)), (&llvm_cbe_tmp__873));
  llvm_cbe_tmp__914 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field17)));
  *(&llvm_cbe_tmp__874) = (((unsigned short )llvm_cbe_tmp__914));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field32)), (&llvm_cbe_tmp__874));
  llvm_cbe_tmp__915 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field18)));
  *(&llvm_cbe_tmp__875) = (((unsigned short )llvm_cbe_tmp__915));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field33)), (&llvm_cbe_tmp__875));
  llvm_cbe_tmp__916 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field19)));
  *(&llvm_cbe_tmp__876) = (((unsigned short )llvm_cbe_tmp__916));
  _ZN13sc_signal_u165writeERKt(((&llvm_cbe_tmp__878->field34)), (&llvm_cbe_tmp__876));
  llvm_cbe_tmp__917 = _ZNSt6iocoutlsEPKc((&_ZSt4cout), ((&_OC_str.array[((signed int )0u)])));
  llvm_cbe_tmp__918 = *(&_ZSt4endl);
  llvm_cbe_tmp__919 = _ZNSt6iocoutlsEi(llvm_cbe_tmp__917, llvm_cbe_tmp__918);
  *(&llvm_cbe_tmp__877) = ((unsigned char )1);
  _ZN14sc_signal_bool5writeERKb(((&llvm_cbe_tmp__878->field35)), (&llvm_cbe_tmp__877));
  llvm_cbe_tmp__920 = *(&conf_done_inp);
  llvm_cbe_tmp__921 = *(&conf_num_hidden_inp);
  llvm_cbe_tmp__922 = *(&conf_num_visible_inp);
  llvm_cbe_tmp__923 = *(&conf_num_users_inp);
  llvm_cbe_tmp__924 = *(&conf_num_loops_inp);
  llvm_cbe_tmp__925 = *(&conf_num_testusers_inp);
  llvm_cbe_tmp__926 = *(&conf_num_movies_inp);
  llvm_cbe_tmp__927 = *(&rst_inp);
  llvm_cbe_tmp__928 = *(&rd_grant_inp);
  llvm_cbe_tmp__929 = *(&data_in_inp);
  llvm_cbe_tmp__930 = *(&wr_grant_inp);
  _ZN9model_RBM6updateElllllllllll((&GM), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__920&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__921)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__922)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__923)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__924)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__925)), (((unsigned long long )(unsigned int )llvm_cbe_tmp__926)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__927&1u))&1)))), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__928&1u))&1)))), (((unsigned long long )(unsigned int )llvm_cbe_tmp__929)), (((unsigned long long )(bool )(((((bool )llvm_cbe_tmp__930&1u))&1)))));
  llvm_cbe_tmp__931 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__878->field35))))&1);
  llvm_cbe_tmp__932 = *((&GM.field3));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__931)) == llvm_cbe_tmp__932), ((&_OC_str1.array[((signed int )0u)])));
  llvm_cbe_tmp__933 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__878->field12))))&1);
  llvm_cbe_tmp__934 = *((&GM.field2));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__933)) == llvm_cbe_tmp__934), ((&_OC_str2.array[((signed int )0u)])));
  llvm_cbe_tmp__935 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field29)));
  llvm_cbe_tmp__936 = *((&GM.field4));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__935)) == llvm_cbe_tmp__936), ((&_OC_str3.array[((signed int )0u)])));
  llvm_cbe_tmp__937 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field30)));
  llvm_cbe_tmp__938 = *((&GM.field9));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__937)) == llvm_cbe_tmp__938), ((&_OC_str4.array[((signed int )0u)])));
  llvm_cbe_tmp__939 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field31)));
  llvm_cbe_tmp__940 = *((&GM.field8));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__939)) == llvm_cbe_tmp__940), ((&_OC_str5.array[((signed int )0u)])));
  llvm_cbe_tmp__941 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field32)));
  llvm_cbe_tmp__942 = *((&GM.field5));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__941)) == llvm_cbe_tmp__942), ((&_OC_str6.array[((signed int )0u)])));
  llvm_cbe_tmp__943 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field33)));
  llvm_cbe_tmp__944 = *((&GM.field7));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__943)) == llvm_cbe_tmp__944), ((&_OC_str7.array[((signed int )0u)])));
  llvm_cbe_tmp__945 = _ZN13sc_signal_u164readEv(((&llvm_cbe_tmp__878->field34)));
  llvm_cbe_tmp__946 = *((&GM.field6));
  __CPROVER_assert(((((unsigned long long )(unsigned short )llvm_cbe_tmp__945)) == llvm_cbe_tmp__946), ((&_OC_str8.array[((signed int )0u)])));
  llvm_cbe_tmp__947 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field2)));
  llvm_cbe_tmp__948 = *((&GM.field13));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__947)) == llvm_cbe_tmp__948), ((&_OC_str9.array[((signed int )0u)])));
  llvm_cbe_tmp__949 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field3)));
  llvm_cbe_tmp__950 = *((&GM.field14));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__949)) == llvm_cbe_tmp__950), ((&_OC_str10.array[((signed int )0u)])));
  llvm_cbe_tmp__951 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__878->field4))))&1);
  llvm_cbe_tmp__952 = *((&GM.field15));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__951)) == llvm_cbe_tmp__952), ((&_OC_str11.array[((signed int )0u)])));
  llvm_cbe_tmp__953 = ((_ZN14sc_signal_bool4readEv(((&llvm_cbe_tmp__878->field9))))&1);
  llvm_cbe_tmp__954 = *((&GM.field20));
  __CPROVER_assert(((((unsigned long long )(bool )llvm_cbe_tmp__953)) == llvm_cbe_tmp__954), ((&_OC_str12.array[((signed int )0u)])));
  llvm_cbe_tmp__955 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field7)));
  llvm_cbe_tmp__956 = *((&GM.field18));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__955)) == llvm_cbe_tmp__956), ((&_OC_str13.array[((signed int )0u)])));
  llvm_cbe_tmp__957 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field8)));
  llvm_cbe_tmp__958 = *((&GM.field19));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__957)) == llvm_cbe_tmp__958), ((&_OC_str14.array[((signed int )0u)])));
  llvm_cbe_tmp__959 = _ZN13sc_signal_u324readEv(((&llvm_cbe_tmp__878->field11)));
  llvm_cbe_tmp__960 = *((&GM.field1));
  __CPROVER_assert(((((unsigned long long )(unsigned int )llvm_cbe_tmp__959)) == llvm_cbe_tmp__960), ((&_OC_str15.array[((signed int )0u)])));
  llvm_cbe_tmp__961 = *((&GM.field0.field0));
  llvm_cbe_tmp__962 = _ZN11SysCArray2DIhLj2ELj512EEixEj(((&llvm_cbe_tmp__878->field20)), 0u);
  llvm_cbe_tmp__963 = ((__CPROVER_array_equal(llvm_cbe_tmp__961, llvm_cbe_tmp__962))&1);
  __CPROVER_assert(llvm_cbe_tmp__963, ((&_OC_str16.array[((signed int )0u)])));
  llvm_cbe_tmp__964 = *((&GM.field10.field0));
  llvm_cbe_tmp__965 = _ZN11SysCArray2DIhLj2ELj128EEixEj(((&llvm_cbe_tmp__878->field28)), 0u);
  llvm_cbe_tmp__966 = ((__CPROVER_array_equal(llvm_cbe_tmp__964, llvm_cbe_tmp__965))&1);
  __CPROVER_assert(llvm_cbe_tmp__966, ((&_OC_str17.array[((signed int )0u)])));
  return;
}


void _ZN13sc_signal_u165writeERKt(struct l_class_OC_sc_signal_u16 *llvm_cbe_this, unsigned short *llvm_cbe_d) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__970;    /* Address-exposed local */
  unsigned short *llvm_cbe_tmp__971;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__972;
  unsigned short *llvm_cbe_tmp__973;
  unsigned short llvm_cbe_tmp__974;

  *(&llvm_cbe_tmp__970) = llvm_cbe_this;
  *(&llvm_cbe_tmp__971) = llvm_cbe_d;
  llvm_cbe_tmp__972 = *(&llvm_cbe_tmp__970);
  llvm_cbe_tmp__973 = *(&llvm_cbe_tmp__971);
  llvm_cbe_tmp__974 = *llvm_cbe_tmp__973;
  *((&llvm_cbe_tmp__972->field0)) = llvm_cbe_tmp__974;
  return;
}


void _ZN14sc_signal_bool5writeERKb(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_d) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__975;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__976;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__977;
  unsigned char *llvm_cbe_tmp__978;
  unsigned char llvm_cbe_tmp__979;

  *(&llvm_cbe_tmp__975) = llvm_cbe_this;
  *(&llvm_cbe_tmp__976) = llvm_cbe_d;
  llvm_cbe_tmp__977 = *(&llvm_cbe_tmp__975);
  llvm_cbe_tmp__978 = *(&llvm_cbe_tmp__976);
  llvm_cbe_tmp__979 = *llvm_cbe_tmp__978;
  *((&llvm_cbe_tmp__977->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__979&1u))&1))));
  return;
}


bool _ZN14sc_signal_boolaSERKb(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_d) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__980;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__981;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__982;
  unsigned char *llvm_cbe_tmp__983;
  unsigned char llvm_cbe_tmp__984;
  unsigned char llvm_cbe_tmp__985;

  *(&llvm_cbe_tmp__980) = llvm_cbe_this;
  *(&llvm_cbe_tmp__981) = llvm_cbe_d;
  llvm_cbe_tmp__982 = *(&llvm_cbe_tmp__980);
  llvm_cbe_tmp__983 = *(&llvm_cbe_tmp__981);
  llvm_cbe_tmp__984 = *llvm_cbe_tmp__983;
  *((&llvm_cbe_tmp__982->field0)) = (((unsigned char )(bool )(((((bool )llvm_cbe_tmp__984&1u))&1))));
  llvm_cbe_tmp__985 = *((&llvm_cbe_tmp__982->field0));
  return (((((bool )llvm_cbe_tmp__985&1u))&1));
}


void _ZN13sc_signal_u325writeERKj(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned int *llvm_cbe_d) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__986;    /* Address-exposed local */
  unsigned int *llvm_cbe_tmp__987;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__988;
  unsigned int *llvm_cbe_tmp__989;
  unsigned int llvm_cbe_tmp__990;

  *(&llvm_cbe_tmp__986) = llvm_cbe_this;
  *(&llvm_cbe_tmp__987) = llvm_cbe_d;
  llvm_cbe_tmp__988 = *(&llvm_cbe_tmp__986);
  llvm_cbe_tmp__989 = *(&llvm_cbe_tmp__987);
  llvm_cbe_tmp__990 = *llvm_cbe_tmp__989;
  *((&llvm_cbe_tmp__988->field0)) = llvm_cbe_tmp__990;
  return;
}


unsigned char *_ZN11SysCArray2DIhLj2ELj512EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  unsigned char *llvm_cbe_tmp__991;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__992;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__993;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__994;
  ...
  *(&llvm_cbe_tmp__992) = llvm_cbe_this;
  *(&llvm_cbe_tmp__993) = llvm_cbe_Xidx;
  llvm_cbe_tmp__994 = *(&llvm_cbe_tmp__992);
  llvm_cbe_tmp__995 = *(&llvm_cbe_tmp__993);
  if ((llvm_cbe_tmp__995 == 0u)) {
...
llvm_cbe_tmp__1000:
  ...
  *(&llvm_cbe_tmp__991) = llvm_cbe_tmp__996;
  goto llvm_cbe_tmp__1002;

llvm_cbe_tmp__1001:
  llvm_cbe_tmp__997 = *(&llvm_cbe_tmp__993);
  llvm_cbe_tmp__998 = *((&llvm_cbe_tmp__994->field0));
  *(&llvm_cbe_tmp__991) = ((&llvm_cbe_tmp__998[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__997) * ((unsigned int )512u)))))))]));
  goto llvm_cbe_tmp__1002;

llvm_cbe_tmp__1002:
  llvm_cbe_tmp__999 = *(&llvm_cbe_tmp__991);
...
unsigned char *_ZN11SysCArray2DIhLj2ELj128EEixEj(struct l_class_OC_SysCArray2D *llvm_cbe_this, unsigned int llvm_cbe_Xidx) {
  unsigned char *llvm_cbe_tmp__1003;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1004;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1005;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1006;
  unsigned int llvm_cbe_tmp__1007;
  unsigned char *llvm_cbe_tmp__1008;
  unsigned int llvm_cbe_tmp__1009;
  unsigned char *llvm_cbe_tmp__1010;
  unsigned char *llvm_cbe_tmp__1011;

  *(&llvm_cbe_tmp__1004) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1005) = llvm_cbe_Xidx;
  llvm_cbe_tmp__1006 = *(&llvm_cbe_tmp__1004);
  llvm_cbe_tmp__1007 = *(&llvm_cbe_tmp__1005);
  if ((llvm_cbe_tmp__1007 == 0u)) {
...
llvm_cbe_tmp__1012:
  llvm_cbe_tmp__1008 = *((&llvm_cbe_tmp__1006->field1));
  *(&llvm_cbe_tmp__1003) = llvm_cbe_tmp__1008;
  goto llvm_cbe_tmp__1014;

llvm_cbe_tmp__1013:
  llvm_cbe_tmp__1009 = *(&llvm_cbe_tmp__1005);
  llvm_cbe_tmp__1010 = *((&llvm_cbe_tmp__1006->field0));
  *(&llvm_cbe_tmp__1003) = ((&llvm_cbe_tmp__1010[((signed long long )(((unsigned long long )(unsigned int )(((unsigned int )(((unsigned int )llvm_cbe_tmp__1009) * ((unsigned int )128u)))))))]));
  goto llvm_cbe_tmp__1014;

llvm_cbe_tmp__1014:
  llvm_cbe_tmp__1011 = *(&llvm_cbe_tmp__1003);
  return llvm_cbe_tmp__1011;
}


bool _ZN14sc_signal_bool4readEv(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1015;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1016;
  unsigned char llvm_cbe_tmp__1017;

  *(&llvm_cbe_tmp__1015) = llvm_cbe_this;
  llvm_cbe_tmp__1016 = *(&llvm_cbe_tmp__1015);
  llvm_cbe_tmp__1017 = *((&llvm_cbe_tmp__1016->field0));
  return (((((bool )llvm_cbe_tmp__1017&1u))&1));
}


unsigned int _ZN13sc_signal_u324readEv(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1018;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1019;
  unsigned int llvm_cbe_tmp__1020;

  *(&llvm_cbe_tmp__1018) = llvm_cbe_this;
  llvm_cbe_tmp__1019 = *(&llvm_cbe_tmp__1018);
  llvm_cbe_tmp__1020 = *((&llvm_cbe_tmp__1019->field0));
  return llvm_cbe_tmp__1020;
}


struct l_class_OC_sc_signal_bool *_ZNSt6iocoutlsEPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_tmp__1021) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1022;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1023;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1024;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1025;
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1026;

  *(&llvm_cbe_tmp__1023) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1024) = llvm_cbe_tmp__1021;
  llvm_cbe_tmp__1025 = *(&llvm_cbe_tmp__1023);
  llvm_cbe_tmp__1026 = *(&llvm_cbe_tmp__1022);
  return llvm_cbe_tmp__1026;
}


struct l_class_OC_sc_signal_bool *_ZNSt6iocoutlsEi(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned int llvm_cbe_tmp__1027) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1028;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1029;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1030;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1031;
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1032;

  *(&llvm_cbe_tmp__1029) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1030) = llvm_cbe_tmp__1027;
  llvm_cbe_tmp__1031 = *(&llvm_cbe_tmp__1029);
  llvm_cbe_tmp__1032 = *(&llvm_cbe_tmp__1028);
  return llvm_cbe_tmp__1032;
}


unsigned short _ZN13sc_signal_u164readEv(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1033;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1034;
  unsigned short llvm_cbe_tmp__1035;

  *(&llvm_cbe_tmp__1033) = llvm_cbe_this;
  llvm_cbe_tmp__1034 = *(&llvm_cbe_tmp__1033);
  llvm_cbe_tmp__1035 = *((&llvm_cbe_tmp__1034->field0));
  return llvm_cbe_tmp__1035;
}
...
void _ZN3rbmC1Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__1036;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__1037;

  *(&llvm_cbe_tmp__1036) = llvm_cbe_this;
  llvm_cbe_tmp__1037 = *(&llvm_cbe_tmp__1036);
  _ZN3rbmC2Ev(llvm_cbe_tmp__1037);
  return;
}


unsigned int main(void) {
  unsigned int llvm_cbe_tmp__1038;    /* Address-exposed local */
  _GLOBAL__I_a();
  CODE_FOR_MAIN();
  *(&llvm_cbe_tmp__1038) = 0u;
  _ZN3rbm6configEv((&IMPL));
  return 0u;
}


void _ZN8type_memIhLj512EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1039;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1040;
  unsigned char *llvm_cbe_tmp__1041;

  *(&llvm_cbe_tmp__1039) = llvm_cbe_this;
  llvm_cbe_tmp__1040 = *(&llvm_cbe_tmp__1039);
  llvm_cbe_tmp__1041 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1040->field0)) = llvm_cbe_tmp__1041;
  return;
}


void _ZN8type_memIhLj512EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1042;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1043;

  *(&llvm_cbe_tmp__1042) = llvm_cbe_this;
  llvm_cbe_tmp__1043 = *(&llvm_cbe_tmp__1042);
  return;
}


void _ZN3rbmC2Ev(struct l_struct_OC_rbm *llvm_cbe_this) {
  struct l_struct_OC_rbm *llvm_cbe_tmp__1044;    /* Address-exposed local */
  struct l_struct_OC_rbm *llvm_cbe_tmp__1045;
  ...
  *(&llvm_cbe_tmp__1044) = llvm_cbe_this;
  llvm_cbe_tmp__1045 = *(&llvm_cbe_tmp__1044);
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field0)), ((&_OC_str19.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field1)), ((&_OC_str20.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field2)), ((&_OC_str21.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field3)), ((&_OC_str22.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field4)), ((&_OC_str23.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field5)), ((&_OC_str24.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field6)), ((&_OC_str25.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field7)), ((&_OC_str26.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field8)), ((&_OC_str27.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field9)), ((&_OC_str28.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field10)), ((&_OC_str29.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field11)), ((&_OC_str30.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field12)), ((&_OC_str31.array[((signed int )0u)])));
  _ZN14sc_signal_boolC1EPKc(((&llvm_cbe_tmp__1045->field13)), ((&_OC_str32.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field14)), ((&_OC_str33.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field15)), ((&_OC_str34.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field16)), ((&_OC_str35.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field17)), ((&_OC_str36.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field18)), ((&_OC_str37.array[((signed int )0u)])));
  _ZN13sc_signal_u32C1EPKc(((&llvm_cbe_tmp__1045->field19)), ((&_OC_str38.array[((signed int )0u)])));
  _ZN11SysCArray2DIhLj2ELj512EEC1Ev(((&llvm_cbe_tmp__1045->field20)));
  _ZN11SysCArray1DIbLj501EEC1Ev(((&llvm_cbe_tmp__1045->field21)));
  _ZN11SysCArray1DIbLj101EEC1Ev(((&llvm_cbe_tmp__1045->field22)));
  _ZN11SysCArray2DIfLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1045->field23)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1045->field24)));
  _ZN11SysCArray2DIbLj501ELj101EEC1Ev(((&llvm_cbe_tmp__1045->field25)));
  _ZN11SysCArray1DIfLj5EEC1Ev(((&llvm_cbe_tmp__1045->field26)));
  _ZN11SysCArray1DIbLj501EEC1Ev(((&llvm_cbe_tmp__1045->field27)));
  _ZN11SysCArray2DIhLj2ELj128EEC1Ev(((&llvm_cbe_tmp__1045->field28)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field29)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field30)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field31)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field32)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field33)));
  _ZN13sc_signal_u16C1Ev(((&llvm_cbe_tmp__1045->field34)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field35)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field36)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field37)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field38)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field39)));
  _ZN15sc_signal_int32C1Ev(((&llvm_cbe_tmp__1045->field40)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field41)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field42)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field43)));
  _ZN14sc_signal_boolC1Ev(((&llvm_cbe_tmp__1045->field44)));
  llvm_cbe_tmp__1046 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1045->field1)));
  llvm_cbe_tmp__1047 = *llvm_cbe_tmp__1046;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1047&1u))&1)))), 0);
  llvm_cbe_tmp__1048 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1045->field1)));
  llvm_cbe_tmp__1049 = *llvm_cbe_tmp__1048;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1049&1u))&1)))), 0);
  llvm_cbe_tmp__1050 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1045->field1)));
  llvm_cbe_tmp__1051 = *llvm_cbe_tmp__1050;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1051&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__1052 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1045->field1)));
  llvm_cbe_tmp__1053 = *llvm_cbe_tmp__1052;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1053&1u))&1)))), 0);
  _Z14set_stack_sizei(5242880u);
  llvm_cbe_tmp__1054 = _ZN14sc_signal_boolcvRbEv(((&llvm_cbe_tmp__1045->field1)));
  llvm_cbe_tmp__1055 = *llvm_cbe_tmp__1054;
  _Z15reset_signal_isib((((unsigned int )(bool )(((((bool )llvm_cbe_tmp__1055&1u))&1)))), 0);
  return;
}


void _ZN14sc_signal_boolC1EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1056;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1057;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1058;
  unsigned char *llvm_cbe_tmp__1059;

  *(&llvm_cbe_tmp__1056) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1057) = llvm_cbe_p;
  llvm_cbe_tmp__1058 = *(&llvm_cbe_tmp__1056);
  llvm_cbe_tmp__1059 = *(&llvm_cbe_tmp__1057);
  _ZN14sc_signal_boolC2EPKc(llvm_cbe_tmp__1058, llvm_cbe_tmp__1059);
  return;
}


void _ZN13sc_signal_u32C1EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1060;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1061;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1062;
  unsigned char *llvm_cbe_tmp__1063;

  *(&llvm_cbe_tmp__1060) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1061) = llvm_cbe_p;
  llvm_cbe_tmp__1062 = *(&llvm_cbe_tmp__1060);
  llvm_cbe_tmp__1063 = *(&llvm_cbe_tmp__1061);
  _ZN13sc_signal_u32C2EPKc(llvm_cbe_tmp__1062, llvm_cbe_tmp__1063);
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1064;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1065;

  *(&llvm_cbe_tmp__1064) = llvm_cbe_this;
  llvm_cbe_tmp__1065 = *(&llvm_cbe_tmp__1064);
  _ZN11SysCArray2DIhLj2ELj512EEC2Ev(llvm_cbe_tmp__1065);
  return;
}


void _ZN11SysCArray1DIbLj501EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1066;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1067;

  *(&llvm_cbe_tmp__1066) = llvm_cbe_this;
  llvm_cbe_tmp__1067 = *(&llvm_cbe_tmp__1066);
  _ZN11SysCArray1DIbLj501EEC2Ev(llvm_cbe_tmp__1067);
  return;
}


void _ZN11SysCArray1DIbLj101EEC1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1068;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1069;

  *(&llvm_cbe_tmp__1068) = llvm_cbe_this;
  llvm_cbe_tmp__1069 = *(&llvm_cbe_tmp__1068);
  _ZN11SysCArray1DIbLj101EEC2Ev(llvm_cbe_tmp__1069);
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC1Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__1070;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__1071;

  *(&llvm_cbe_tmp__1070) = llvm_cbe_this;
  llvm_cbe_tmp__1071 = *(&llvm_cbe_tmp__1070);
  _ZN11SysCArray2DIfLj501ELj101EEC2Ev(llvm_cbe_tmp__1071);
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1072;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1073;

  *(&llvm_cbe_tmp__1072) = llvm_cbe_this;
  llvm_cbe_tmp__1073 = *(&llvm_cbe_tmp__1072);
  _ZN11SysCArray2DIbLj501ELj101EEC2Ev(llvm_cbe_tmp__1073);
  return;
}


void _ZN11SysCArray1DIfLj5EEC1Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__1074;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__1075;

  *(&llvm_cbe_tmp__1074) = llvm_cbe_this;
  llvm_cbe_tmp__1075 = *(&llvm_cbe_tmp__1074);
  _ZN11SysCArray1DIfLj5EEC2Ev(llvm_cbe_tmp__1075);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC1Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1076;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1077;

  *(&llvm_cbe_tmp__1076) = llvm_cbe_this;
  llvm_cbe_tmp__1077 = *(&llvm_cbe_tmp__1076);
  _ZN11SysCArray2DIhLj2ELj128EEC2Ev(llvm_cbe_tmp__1077);
  return;
}


void _ZN13sc_signal_u16C1Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1078;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1079;

  *(&llvm_cbe_tmp__1078) = llvm_cbe_this;
  llvm_cbe_tmp__1079 = *(&llvm_cbe_tmp__1078);
  _ZN13sc_signal_u16C2Ev(llvm_cbe_tmp__1079);
  return;
}


void _ZN14sc_signal_boolC1Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1080;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1081;

  *(&llvm_cbe_tmp__1080) = llvm_cbe_this;
  llvm_cbe_tmp__1081 = *(&llvm_cbe_tmp__1080);
  _ZN14sc_signal_boolC2Ev(llvm_cbe_tmp__1081);
  return;
}


void _ZN15sc_signal_int32C1Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1082;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1083;

  *(&llvm_cbe_tmp__1082) = llvm_cbe_this;
  llvm_cbe_tmp__1083 = *(&llvm_cbe_tmp__1082);
  _ZN15sc_signal_int32C2Ev(llvm_cbe_tmp__1083);
  return;
}


unsigned char *_ZN14sc_signal_boolcvRbEv(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1084;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1085;

  *(&llvm_cbe_tmp__1084) = llvm_cbe_this;
  llvm_cbe_tmp__1085 = *(&llvm_cbe_tmp__1084);
  return ((&llvm_cbe_tmp__1085->field0));
}


void _ZN15sc_signal_int32C2Ev(struct l_class_OC_sc_signal_int32 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1086;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1087;

  *(&llvm_cbe_tmp__1086) = llvm_cbe_this;
...
void _ZN14sc_signal_boolC2Ev(struct l_class_OC_sc_signal_bool *llvm_cbe_this) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1088;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1089;

  *(&llvm_cbe_tmp__1088) = llvm_cbe_this;
  llvm_cbe_tmp__1089 = *(&llvm_cbe_tmp__1088);
  return;
}


void _ZN13sc_signal_u16C2Ev(struct l_class_OC_sc_signal_u16 *llvm_cbe_this) {
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1090;    /* Address-exposed local */
  struct l_class_OC_sc_signal_u16 *llvm_cbe_tmp__1091;

  *(&llvm_cbe_tmp__1090) = llvm_cbe_this;
  llvm_cbe_tmp__1091 = *(&llvm_cbe_tmp__1090);
  return;
}


void _ZN11SysCArray2DIhLj2ELj128EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1092;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1093;
  unsigned char *llvm_cbe_tmp__1094;
  unsigned char *llvm_cbe_tmp__1095;

  *(&llvm_cbe_tmp__1092) = llvm_cbe_this;
  llvm_cbe_tmp__1093 = *(&llvm_cbe_tmp__1092);
  llvm_cbe_tmp__1094 = __CPROVER_malloc(256ull);
  *((&llvm_cbe_tmp__1093->field0)) = llvm_cbe_tmp__1094;
  llvm_cbe_tmp__1095 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__1093->field1)) = llvm_cbe_tmp__1095;
  return;
}


void _ZN11SysCArray1DIfLj5EEC2Ev(struct l_unnamed4 *llvm_cbe_this) {
  struct l_unnamed4 *llvm_cbe_tmp__1096;    /* Address-exposed local */
  struct l_unnamed4 *llvm_cbe_tmp__1097;
  unsigned char *llvm_cbe_tmp__1098;

  *(&llvm_cbe_tmp__1096) = llvm_cbe_this;
  llvm_cbe_tmp__1097 = *(&llvm_cbe_tmp__1096);
  llvm_cbe_tmp__1098 = __CPROVER_malloc(20ull);
  *((&llvm_cbe_tmp__1097->field0)) = (((float *)llvm_cbe_tmp__1098));
  return;
}


void _ZN11SysCArray2DIbLj501ELj101EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1099;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1100;
  unsigned char *llvm_cbe_tmp__1101;
  unsigned char *llvm_cbe_tmp__1102;

  *(&llvm_cbe_tmp__1099) = llvm_cbe_this;
  llvm_cbe_tmp__1100 = *(&llvm_cbe_tmp__1099);
  llvm_cbe_tmp__1101 = __CPROVER_malloc(50601ull);
  *((&llvm_cbe_tmp__1100->field0)) = llvm_cbe_tmp__1101;
  llvm_cbe_tmp__1102 = __CPROVER_malloc(101ull);
  *((&llvm_cbe_tmp__1100->field1)) = llvm_cbe_tmp__1102;
  return;
}


void _ZN11SysCArray2DIfLj501ELj101EEC2Ev(struct l_unnamed3 *llvm_cbe_this) {
  struct l_unnamed3 *llvm_cbe_tmp__1103;    /* Address-exposed local */
  struct l_unnamed3 *llvm_cbe_tmp__1104;
  unsigned char *llvm_cbe_tmp__1105;
  unsigned char *llvm_cbe_tmp__1106;

  *(&llvm_cbe_tmp__1103) = llvm_cbe_this;
  llvm_cbe_tmp__1104 = *(&llvm_cbe_tmp__1103);
  llvm_cbe_tmp__1105 = __CPROVER_malloc(202404ull);
  *((&llvm_cbe_tmp__1104->field0)) = (((float *)llvm_cbe_tmp__1105));
  llvm_cbe_tmp__1106 = __CPROVER_malloc(404ull);
  *((&llvm_cbe_tmp__1104->field1)) = (((float *)llvm_cbe_tmp__1106));
  return;
}


void _ZN11SysCArray1DIbLj101EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1107;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1108;
  unsigned char *llvm_cbe_tmp__1109;

  *(&llvm_cbe_tmp__1107) = llvm_cbe_this;
  llvm_cbe_tmp__1108 = *(&llvm_cbe_tmp__1107);
  llvm_cbe_tmp__1109 = __CPROVER_malloc(101ull);
  *((&llvm_cbe_tmp__1108->field0)) = llvm_cbe_tmp__1109;
  return;
}


void _ZN11SysCArray1DIbLj501EEC2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1110;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1111;
  unsigned char *llvm_cbe_tmp__1112;

  *(&llvm_cbe_tmp__1110) = llvm_cbe_this;
  llvm_cbe_tmp__1111 = *(&llvm_cbe_tmp__1110);
  llvm_cbe_tmp__1112 = __CPROVER_malloc(501ull);
  *((&llvm_cbe_tmp__1111->field0)) = llvm_cbe_tmp__1112;
  return;
}


void _ZN11SysCArray2DIhLj2ELj512EEC2Ev(struct l_class_OC_SysCArray2D *llvm_cbe_this) {
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1113;    /* Address-exposed local */
  struct l_class_OC_SysCArray2D *llvm_cbe_tmp__1114;
  unsigned char *llvm_cbe_tmp__1115;
  unsigned char *llvm_cbe_tmp__1116;

  *(&llvm_cbe_tmp__1113) = llvm_cbe_this;
  llvm_cbe_tmp__1114 = *(&llvm_cbe_tmp__1113);
  llvm_cbe_tmp__1115 = __CPROVER_malloc(1024ull);
  *((&llvm_cbe_tmp__1114->field0)) = llvm_cbe_tmp__1115;
  llvm_cbe_tmp__1116 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1114->field1)) = llvm_cbe_tmp__1116;
  return;
}


void _ZN13sc_signal_u32C2EPKc(struct l_class_OC_sc_signal_int32 *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1117;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1118;    /* Address-exposed local */
  struct l_class_OC_sc_signal_int32 *llvm_cbe_tmp__1119;

  *(&llvm_cbe_tmp__1117) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1118) = llvm_cbe_p;
  llvm_cbe_tmp__1119 = *(&llvm_cbe_tmp__1117);
  return;
}


void _ZN14sc_signal_boolC2EPKc(struct l_class_OC_sc_signal_bool *llvm_cbe_this, unsigned char *llvm_cbe_p) {
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1120;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1121;    /* Address-exposed local */
  struct l_class_OC_sc_signal_bool *llvm_cbe_tmp__1122;

  *(&llvm_cbe_tmp__1120) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1121) = llvm_cbe_p;
  llvm_cbe_tmp__1122 = *(&llvm_cbe_tmp__1120);
  return;
}


void _ZN9model_RBMD2Ev(struct l_class_OC_model_RBM *llvm_cbe_this) {
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1123;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1124;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1125;    /* Address-exposed local */
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1126;

  *(&llvm_cbe_tmp__1123) = llvm_cbe_this;
  llvm_cbe_tmp__1126 = *(&llvm_cbe_tmp__1123);
  _ZN8type_memIhLj128EED1Ev(((&llvm_cbe_tmp__1126->field10)));
  _ZN8type_memIhLj512EED1Ev(((&llvm_cbe_tmp__1126->field0)));
  return;
}


void _ZN8type_memIhLj128EED1Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1127;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1128;

  *(&llvm_cbe_tmp__1127) = llvm_cbe_this;
  llvm_cbe_tmp__1128 = *(&llvm_cbe_tmp__1127);
  _ZN8type_memIhLj128EED2Ev(llvm_cbe_tmp__1128);
  return;
}


void _ZN8type_memIhLj128EED2Ev(struct l_class_OC_SysCArray1D *llvm_cbe_this) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1129;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1130;

  *(&llvm_cbe_tmp__1129) = llvm_cbe_this;
...
void _ZN9model_RBMC2Ev(struct l_class_OC_model_RBM *llvm_cbe_this) {
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1131;    /* Address-exposed local */
  unsigned char *llvm_cbe_tmp__1132;    /* Address-exposed local */
  unsigned int llvm_cbe_tmp__1133;    /* Address-exposed local */
  struct l_class_OC_model_RBM *llvm_cbe_tmp__1134;

  *(&llvm_cbe_tmp__1131) = llvm_cbe_this;
  llvm_cbe_tmp__1134 = *(&llvm_cbe_tmp__1131);
  _ZN8type_memIhLj512EEC1El(((&llvm_cbe_tmp__1134->field0)), 0ull);
  _ZN8type_memIhLj128EEC1El(((&llvm_cbe_tmp__1134->field10)), 0ull);
  *((&llvm_cbe_tmp__1134->field21)) = 65535ull;
  *((&llvm_cbe_tmp__1134->field22)) = 255ull;
  return;
}


void _ZN8type_memIhLj512EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1135;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1136;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1137;
  unsigned long long llvm_cbe_tmp__1138;

  *(&llvm_cbe_tmp__1135) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1136) = llvm_cbe_def;
  llvm_cbe_tmp__1137 = *(&llvm_cbe_tmp__1135);
  llvm_cbe_tmp__1138 = *(&llvm_cbe_tmp__1136);
  _ZN8type_memIhLj512EEC2El(llvm_cbe_tmp__1137, llvm_cbe_tmp__1138);
  return;
}


void _ZN8type_memIhLj128EEC1El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1139;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1140;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1141;
  unsigned long long llvm_cbe_tmp__1142;

  *(&llvm_cbe_tmp__1139) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1140) = llvm_cbe_def;
  llvm_cbe_tmp__1141 = *(&llvm_cbe_tmp__1139);
  llvm_cbe_tmp__1142 = *(&llvm_cbe_tmp__1140);
  _ZN8type_memIhLj128EEC2El(llvm_cbe_tmp__1141, llvm_cbe_tmp__1142);
  return;
}


void _ZN8type_memIhLj128EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1143;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1144;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1145;
  unsigned char *llvm_cbe_tmp__1146;

  *(&llvm_cbe_tmp__1143) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1144) = llvm_cbe_def;
  llvm_cbe_tmp__1145 = *(&llvm_cbe_tmp__1143);
  llvm_cbe_tmp__1146 = __CPROVER_malloc(128ull);
  *((&llvm_cbe_tmp__1145->field0)) = llvm_cbe_tmp__1146;
  return;
}


void _ZN8type_memIhLj512EEC2El(struct l_class_OC_SysCArray1D *llvm_cbe_this, unsigned long long llvm_cbe_def) {
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1147;    /* Address-exposed local */
  unsigned long long llvm_cbe_tmp__1148;    /* Address-exposed local */
  struct l_class_OC_SysCArray1D *llvm_cbe_tmp__1149;
  unsigned char *llvm_cbe_tmp__1150;

  *(&llvm_cbe_tmp__1147) = llvm_cbe_this;
  *(&llvm_cbe_tmp__1148) = llvm_cbe_def;
  llvm_cbe_tmp__1149 = *(&llvm_cbe_tmp__1147);
  llvm_cbe_tmp__1150 = __CPROVER_malloc(512ull);
  *((&llvm_cbe_tmp__1149->field0)) = llvm_cbe_tmp__1150;
  return;
}

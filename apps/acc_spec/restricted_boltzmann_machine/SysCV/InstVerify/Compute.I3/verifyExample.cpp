...
// edges is ignored for FixPoint
		return;
		// *** END of LABEL: @compute.Finish@END
 

   
__compute_Finish__START:
		 rst_inp = 0 ; // __CPROVER_assume( rst_inp == 0 );
		 init_done = 1 ; // __CPROVER_assume( init_done == 1 );
		 GM.upc = 3 ; // __CPROVER_assume( GM.upc == 3 );
		...
		// *** END of LABEL: @compute.Finish@START

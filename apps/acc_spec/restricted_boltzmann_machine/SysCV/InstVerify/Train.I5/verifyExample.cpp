...
__train_i5__START:
       ...
       GM.train_upc = 3 ; // __CPROVER_assume( GM.train_upc == 3 );
      ...
      // *** END of LABEL: @train.i5@START

       __CPROVER_assume(nv <= NUM_VISIBLE_MAX);
       __CPROVER_assume(nh <= NUM_HIDDEN_MAX);
       //goto loopin;
         //for (v = 0; v < NUM_VISIBLE_MAX + 1; v++)
         //{
            if(v == nv + 1)

...
assume -name {cycle1-begin-match1} -env \
{
...
assume -name {cycle1-begin-match2} -env \
{
    (acc_0.state_rbm_0_cmos32soi_rbm_train_rbm[8] == 1) |-> (GM.train_h_cnt == acc_0.mux_h_ln184_z)
}

assume -name {cycle1-decode} -env \
{
    nondet_start |-> (
...
{
    GM_step == (acc_0.state_rbm_0_cmos32soi_rbm_train_rbm_next[90] == 1)
}
